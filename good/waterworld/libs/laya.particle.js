    ...
    class a {
        ...
        static Create(t, i, r, s) {
            ...
            if (a._tempVelocity[0] += l * Math.cos(h), a._tempVelocity[2] += l * Math.sin(h),
                ...
                for (o = 0; o < 4; o++) n.startColor[o] = e.MathUtil.lerp(t.minStartColor[o], t.maxStartColor[o], Math.random()),
                    n.endColor[o] = e.MathUtil.lerp(t.minEndColor[o], t.maxEndColor[o], Math.random());
            else e.MathUtil.lerpVector4(t.minStartColor, t.maxStartColor, Math.random(), n.startColor),
    ...
    class d {
        ...
        advanceTime(t = 1) {
            if (this._emissionTime -= t, !(this._emissionTime < 0 || (this._frameTime += t,
                ...
                for (; this._frameTime > this.minEmissionTime;) this._frameTime -= this.minEmissionTime,
                    this.emit();
        }
    }
    class c extends d {
