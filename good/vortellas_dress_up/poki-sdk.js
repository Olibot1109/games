(() => {
  ...
  const a = new (class {
    #e = [];
    enqueue(e, o, i, a) {
      const n = { fn: e, args: o || [], resolveFn: i, rejectFn: a };
      t ? i && i(!0) : this.#e.push(n);
    }
    dequeue() {
      for (; this.#e.length > 0; ) {
  ...
  if (
    ...
    try {
      ...
      const o = crypto.randomUUID(),
        i = e("game_id"),
        a = e("game_version_id"),
        n = "1" === localStorage.getItem("poki_pbf");
          ...
          window.parent.postMessage(
            {
              ...
              content: {
                ...
                data: { category: e, action: r, label: s },
              },
            },
            "*"
          ),
  ...
  const n = (() => {
      const a =
        ...
        e("ab") ||
        "9d30ff633644aaf120bae76a1f5bdd378eb18eaa";
      let n = `poki-sdk-core-${a}.js`;
      return (
        t && (n = `poki-sdk-kids-${a}.js`),
        o && (n = `poki-sdk-playground-${a}.js`),
        i && (n = `poki-sdk-hoist-${a}.js`),
        `poki-core.js`
      );
    })(),
