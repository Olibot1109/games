(() => {
  ...
  (() => {
    ...
    function x(e, t) {
      ...
      if (e.expire > Date.now() + f) return !1;
      if (t) {
        if (void 0 !== e.referrer_domain) {
          var i = k(),
            n = g.has(i);
          if ("poki" !== i && !n && i !== e.referrer_domain) return !1;
        }
    ...
    function _() {
      var e = null;
      x(window[window._pokiSessionGlobalName], !1) &&
        (e = window[window._pokiSessionGlobalName]);
      try {
        var t = sessionStorage.getItem(b);
        if (t) {
          var i = JSON.parse(t);
          x(i, !0) && (!e || i.depth > e.depth) && (e = i);
        }
      } catch (e) {
        try {
          r(e, "getSession", sessionStorage.getItem(b));
        } catch (t) {
          r(e, "getSession", t);
        }
      }
    ...
    function I() {
      ...
      try {
        ...
        try {
          r(e, "getPreviousSessionCount", sessionStorage.getItem(b));
        } catch (t) {
      ...
      try {
        ...
        try {
          r(e, "getPreviousSessionCount", n(b));
        } catch (t) {
          r(e, "getPreviousSessionCount", t);
        }
      }
    ...
    function E() {
      ...
      try {
        ...
        if (i) {
          var o = JSON.parse(i);
          !x(o, !0) || (t && o.id !== t.id) || (e = Math.max(e, o.depth));
        }
      } catch (e) {
        var a = null;
        try {
                ...
                if (s) {
                  ...
                  if (x(d, !0))
                    return (
                      ...
                      (d.page.pageview_id = a()),
                      (d.depth = E() + 1),
                      (d.expire = Date.now() + f),
                      (d.tab_id = S()),
                      o(b, JSON.stringify(d)),
                      d
                    );
                }
              } catch (e) {
              ...
              var l = a(),
                p = (function () {
                  ...
                  var D,
                    ...
                    z =
                      R &&
                      x.includes("mobileapp::") &&
                      x.includes("mobileapp::2-")
                        ? (function (e) {
                            var t =
                  ...
                  var U,
                    ...
                    G =
                      !g.has(F) &&
                      (v.has(M) ||
                        /^com\.google\.android\.googlequicksearchbox$/.test(
                          F
                        ) ||
                        /^webcache\.googleusercontent\.com$/.test(F) ||
                        (!!y && "share" !== b));
                  return (
                    (U =
                      "snapchat" === f
    ...
    class G {
      static sendMessage(t, i, n = window.parent) {
        ...
        F.gameID &&
          F.versionID &&
          (o.pokifordevs = { game_id: F.gameID, game_version_id: F.versionID }),
          n?.postMessage({ type: t, content: o }, "*");
      }
    }
    class V {
      static debug = !1;
      ...
      static init = (e, t) => {
        ...
        void 0 === e &&
          ...
          F.isInspector
            ? ((e = !0), (t = !0))
            : i.endsWith(".poki-gdn.com") && ((e = !1), (t = !1)),
          F.debugMode && (e = !0),
          F.logMode && (t = !0),
          void 0 === t && (t = e),
          (V.debug = e),
    ...
    const H = (e) => {
        ...
        return (
          Object.keys(e).forEach((i) => {
            "object" == typeof e[i] ? (t = t.concat(H(e[i]))) : t.push(e[i]);
          }),
          t
        );
      },
      ...
      new Promise((i, n) => {
        ...
        const a = () => {
          (o.readyState &&
            ...
            (i(), (o.onload = null), (o.onreadystatechange = null));
        };
        (o.onload = a),
    ...
    class te {
      ...
      static track(t, i = {}) {
        try {
          ...
          const o = Q.getVideoDataAnnotations();
          if (o?.pokiAdServer)
            switch (t) {
              case e.tracking.ads.status.started: {
                const { creativeId: e } = o;
                Q.addVideoDataAnnotations({ houseAdId: e }), (n.houseAdId = e);
                break;
              }
          ...
          if ((t.includes("pokiTrackingRewardedWeb") && (n = o), V.log)) {
      ...
      static setupObserver() {
        for (
          ee._pokiSessionGlobalName = "pokiSession",
            ...
            C(window.location.pathname, "external", F.contentGameID),
            (function () {
              var e,
                t,
                i,
                ...
                m =
                  ...
                  void 0 === t
                    ...
                    : t.is_new) || !1,
                u =
                  (null === (i = window[window._pokiUserGlobalName]) ||
                  void 0 === i
                    ? void 0
                    : i.version) || 0,
                g =
    ...
    class oe {
      static async collectAndLog() {
        try {
          const e = { cookies: await ne(), p4d_game_id: F.gameID, user_id: ie };
      ...
      static trackSavegames() {
        window.cookieStore &&
          ...
          (Math.random() > 0.01 ||
            ...
            (oe.collectAndLog(), setInterval(oe.collectAndLog, 12e4)));
      }
    }
    let ae,
      re,
    ...
    const le = () => {
        ce++,
          (ae = setTimeout(le, 100 * ce)),
          window.__tcfapi &&
            window.__tcfapi("ping", 2, (e, t) => {
              t && e?.cmpLoaded && ((se = !0), clearTimeout(ae));
            });
      },
      pe = () => {
        ce++,
      ...
      Ae = () => {
        F.gdprApplies
          ? (!(function () {
              if (window.__tcfapi || F.isPlayground || F.familyFriendly) return;
              const e = window.top,
                t = {};
              let i = !1;
              const n = [];
              (window.__tcfapi = (o, a, r, s) => {
                if (!i) return n.push([o, a, r, s]), !0;
                const d = `${Math.random()}`,
                  c = {
                    __tcfapiCall: {
                      command: o,
              ...
              (t[o] = (e, t) => {
                ...
                (a = setInterval(() => {
                  e.postMessage(
                    {
                      __tcfapiCall: { command: "ping", version: 2, callId: o },
                    },
                    "*"
                  );
                }, 500)),
          ...
          F.ccpaApplies &&
            (!(function () {
              if (window.__uspapi || F.isPlayground || F.familyFriendly) return;
              const e = window.top,
                t = {};
              (window.__uspapi = (i, n, o) => {
                const a = `${Math.random()}`,
                  r = { __uspapiCall: { command: i, version: n, callId: a } };
                (t[a] = o), e.postMessage(r, "*");
              }),
                window.addEventListener(
                  "message",
                  function (e) {
        ...
        const t = ve.adTiming,
          {
            ...
            timeBetweenAds: o = t.timeBetweenAds,
            startAdsAfter: a = t.startAdsAfter,
          } = e;
        this.#e = {
          preroll: !1 !== i,
          timePerTry: n,
    ...
    async function ke(e, t = {}, i = 5e3) {
      ...
      try {
        const t = await Promise.race([fetch(e, a), s]);
    ...
    let Ee,
      Ce = [];
    const Pe = (e) =>
      Ce.includes(e) || Ce.includes(`www.${e}`) || e?.includes?.("game");
    function Be() {
      let e;
      return Ee && (e = Ee.join(";")), (Ee = void 0), e;
    }
    const Te = () =>
        "undefined" != typeof navigator &&
        /MSIE \\d|Trident.*rv:/i.test(navigator.userAgent),
      De = F.AYMode === O.DPF_ONLY || F.AYMode === O.PBS_DPF_CSTS,
      Me = "rewarded",
      Re = "video",
      Le = De
        ? {
      ...
      Ge = "lcpgaTLqkd6gRi8AVtVr0gLe",
      Ve = "PIsUL8EJvXXA1thcFkCPWdhi",
      He = "KQ3P2qVndkjlesGkzM5Rknma",
      ...
      At = "external";
    function mt() {
      return F.isPokiIframe || F.isPlayground ? (F.isPlayground ? lt : pt) : At;
    }
    const ut = {
      skyscraper: "160x600",
      rectangle: "300x250",
    ...
    const wt = () =>
      ...
      F.forceStartAY;
    function vt(e = "display") {
      return (
        !!F.forceStartAY ||
        F.AYMode === O.PBS_ONLY ||
        ([O.ON, O.PBS_DPF_CSTS].includes(F.AYMode) && wt())
      );
    }
    function ft() {
      return (
        ([O.ON, O.PBS_DPF_CSTS, O.DPF_ONLY].includes(F.AYMode) &&
          ["US", "MX", "DE", "FR", "AU", "ES", "IT", "NZ"].includes(
            F.country
          )) ||
        F.forceStartAY
      );
    ...
    function bt() {
      return !!window?.assertive?.addAmazonFloors && ft();
    }
    async function yt() {
      ...
      const i = vt(),
        n = ft(),
        o = [O.ON, O.PBS_DPF_CSTS, O.CSTS_ONLY].includes(e) || F.forceStartAY;
      (window.assertive = {
        ...
        reduction: { enabled: o, limit: { percentage: o ? 1 : 0 } },
        floor: {
          enabled: n,
          addToHashKey: !1,
          currency: "EUR",
        ...
        (function () {
          try {
            if (
              ...
              (window.pokiGetDPFEnabledResult = ft()),
        ...
        await X(
          "https://a.poki-cdn.com/ay/client-v2_2dc0d61692f444998190571ae893366936a09ab8.js"
        ),
        i &&
          (await X(
    ...
    function kt(e, t) {
      if (ft() && ht?.contentWindow?.floorModuleLoaded)
        try {
    ...
    function xt(e, t, i, n, o) {
      let a = Et("AdSystem", "Poki", { version: "0.1" });
      return (
        t &&
          (a += (function (e) {
    ...
    function Ct(e) {
      const t = e;
      return {
        getVastXmlWithTracking: function (e, n, o, a, r) {
          ...
          return (
            (function (e, t, n) {
              const o = e.querySelectorAll("InLine,Wrapper"),
                a = o.length;
              for (let e = 0; e < a; e++) {
                const r = o[e],
                  s = e < a - 1;
    ...
    function Mt() {
      const e = Q.getVideoDataAnnotations(),
        t = (function (e) {
          ...
          if (!t) return;
          const { adUnitCode: i, requestId: n, auctionId: o } = t,
            a = t.adId,
            { bids: r } = window.pbjs.getBidResponsesForAdUnitCode(i);
          return r.find(
            (e) => e.adId === a && e.requestId === n && e.auctionId === o
          );
        })(e?.IMAWrapperIDs || []);
      if (t) {
    ...
    const Rt = (e) => {
      const { adId: t, adUnitCode: i, requestId: n, auctionId: o } = e,
        a = `poki_${Bt()}`;
      Dt.store(a, { adId: t, adUnitCode: i, requestId: n, auctionId: o });
      let { vastXml: r } = e;
      const { vastUrl: s } = e;
      return (
        r
          ? (r = Tt.getVastXmlWithTracking(r, a, void 0, void 0, void 0))
          : s && (r = Tt.buildVastWrapper(a, s, void 0, void 0, void 0)),
        (e.vastXml = r),
        a
      );
    };
    ...
    const Ft = (e = "display") =>
            ...
            const e = "1--",
              ...
              i = (t) => {
                const i = {
                  ...
                  ...(F.ccpaApplies ? { params: { aps_privacy: t || e } } : {}),
                  signals: Ut,
                };
      ...
      Ht = (t, i) => {
        const n = {
            ...
            return {
              bids: [
                ...
                },
                {
                  bidder: "sharethrough",
                  params: {
                    pkey: e ? Le[F.device].rewarded : Le[F.device].midroll,
                    bcat: Ot,
                  },
                },
                {
                ...
                },
                {
                  ...
                  params: {
                    ...
                    adUnitId: e ? We[F.device].rewarded : We[F.device].midroll,
                  },
                },
                {
                  bidder: "yieldmo",
                ...
                },
                {
                  ...
                  params: {
                    cid: "8CU2QB97K",
                    crid: e ? Xe[F.device].rewarded : Xe[F.device].midroll,
                  },
                },
                ...(vt("video")
                  ? [
                      ...
                      },
                      {
                        ...
                        params: {
                          pid: e ? nt[F.device].rewarded : nt[F.device].midroll,
                          supplyType: "site",
                        },
                      },
                      {
                      ...
                      },
                      {
                        ...
                        params: {
                          tagId: "yKyauEkOj",
                          adUnitId: e
                            ? `PBS_${We[F.device].rewarded}`
                            : `PBS_${We[F.device].midroll}`,
                        },
                      },
                      {
                        bidder: "yieldmo_s2s",
          ...
          r = o(!1),
          s = [
            { code: Re, mediaTypes: r.mediaTypes, bids: [...r.bids] },
            { code: Me, mediaTypes: a.mediaTypes, bids: [...a.bids] },
            {
              code: n["728x90"],
              ...
              bids: [
                ...
                { bidder: "ix", params: { siteId: ze[F.device]["728x90"] } },
                {
                  bidder: "pubmatic",
                  params: {
                    publisherId: "156838",
                ...
                },
                {
                  ...
                  params: {
                    pubId: "6da09f566a9dc06",
                    ext: { placement_name: je[F.device]["728x90"] },
                  },
                },
                {
                  bidder: "richaudience",
                  params: { pid: Ue[F.device]["728x90"], supplyType: "site" },
                },
                {
                  bidder: "sharethrough",
                  params: { pkey: Le[F.device]["728x90"], bcat: Ot },
                },
                {
                  bidder: "triplelift",
                  params: { inventoryCode: Qe[F.device]["728x90"] },
                },
                {
                  bidder: "amx",
                  params: {
                    tagId: Ke[F.device]["728x90"],
                    adUnitId: We[F.device]["728x90"],
                  },
                },
                {
                  bidder: "yieldmo",
                  params: { placementId: $e[F.device]["728x90"] },
                },
                {
                  bidder: "unruly",
                  params: { siteId: Ze[F.device]["728x90"] },
                },
                {
                  bidder: "medianet",
                  params: { cid: "8CU2QB97K", crid: Xe[F.device]["728x90"] },
                },
                ...(vt()
                  ? [
                      {
                        ...
                        params: {
                          delDomain: "poki-d.openx.net",
                          unit: at[F.device]["728x90"],
                        },
                      },
                      {
                        bidder: "ix_s2s",
                        params: { siteId: it[F.device]["728x90"] },
                      },
                      {
                        bidder: "pubmatic_s2s",
                        params: {
                          publisherId: "156838",
                          adSlot: tt[F.device]["728x90"],
                          bcat: Ot,
                        },
                      },
                      {
                      ...
                      },
                      {
                        bidder: "richaudience_s2s",
                        params: {
                          pid: nt[F.device]["728x90"],
                          supplyType: "site",
                        },
                      },
                      {
                        bidder: "sharethrough_s2s",
                        params: { pkey: Je[F.device]["728x90"], bcat: Ot },
                      },
                      {
                        bidder: "triplelift_s2s",
                        params: { inventoryCode: Ye[F.device]["728x90"] },
                      },
                      {
                        bidder: "amx_s2s",
                        params: {
                          tagId: "yKyauEkOj",
                          adUnitId: `PBS_${We[F.device]["728x90"]}`,
                        },
                      },
                      {
                        bidder: "yieldmo_s2s",
                        params: { placementId: rt[F.device]["728x90"] },
                      },
                      {
                        bidder: "unruly_s2s",
                        params: { siteId: st[F.device]["728x90"] },
                      },
                      {
                        bidder: "medianet_s2s",
                        params: {
                          cid: "8CU2QB97K",
                          crid: ct[F.device]["728x90"],
                        },
                      },
                    ]
                  : []),
            ...
            },
            {
              ...
              bids: [
                ...
                { bidder: "ix", params: { siteId: ze[F.device]["300x250"] } },
                {
                  bidder: "pubmatic",
                  params: {
                    publisherId: "156838",
                ...
                },
                {
                  ...
                  params: {
                    pubId: "6da09f566a9dc06",
                    ext: { placement_name: je[F.device]["300x250"] },
                  },
                },
                {
                  bidder: "richaudience",
                  params: { pid: Ue[F.device]["300x250"], supplyType: "site" },
                },
                {
                  bidder: "sharethrough",
                  params: { pkey: Le[F.device]["300x250"], bcat: Ot },
                },
                {
                  bidder: "triplelift",
                  params: { inventoryCode: Qe[F.device]["300x250"] },
                },
                {
                  bidder: "amx",
                  params: {
                    tagId: Ke[F.device]["300x250"],
                    adUnitId: We[F.device]["300x250"],
                  },
                },
                {
                  bidder: "yieldmo",
                  params: { placementId: $e[F.device]["300x250"] },
                },
                {
                  bidder: "unruly",
                  params: { siteId: Ze[F.device]["300x250"] },
                },
                {
                  bidder: "medianet",
                  params: { cid: "8CU2QB97K", crid: Xe[F.device]["300x250"] },
                },
                ...(vt()
                  ? [
                      {
                        ...
                        params: {
                          delDomain: "poki-d.openx.net",
                          unit: at[F.device]["300x250"],
                        },
                      },
                      {
                        bidder: "ix_s2s",
                        params: { siteId: it[F.device]["300x250"] },
                      },
                      {
                        bidder: "pubmatic_s2s",
                        params: {
                          publisherId: "156838",
                          adSlot: tt[F.device]["300x250"],
                          bcat: Ot,
                        },
                      },
                      {
                      ...
                      },
                      {
                        bidder: "richaudience_s2s",
                        params: {
                          pid: nt[F.device]["300x250"],
                          supplyType: "site",
                        },
                      },
                      {
                        bidder: "sharethrough_s2s",
                        params: { pkey: Je[F.device]["300x250"], bcat: Ot },
                      },
                      {
                        bidder: "triplelift_s2s",
                        params: { inventoryCode: Ye[F.device]["300x250"] },
                      },
                      {
                        bidder: "amx_s2s",
                        params: {
                          tagId: "yKyauEkOj",
                          adUnitId: `PBS_${We[F.device]["300x250"]}`,
                        },
                      },
                      {
                        bidder: "yieldmo_s2s",
                        params: { placementId: rt[F.device]["300x250"] },
                      },
                      {
                        bidder: "unruly_s2s",
                        params: { siteId: st[F.device]["300x250"] },
                      },
                      {
                        bidder: "medianet_s2s",
                        params: {
                          cid: "8CU2QB97K",
                          crid: ct[F.device]["300x250"],
                        },
                      },
                    ]
                  : []),
            ...
            },
            {
              ...
              bids: [
                ...
                { bidder: "ix", params: { siteId: ze[F.device]["970x250"] } },
                {
                  bidder: "pubmatic",
                  params: {
                    publisherId: "156838",
                ...
                },
                {
                  ...
                  params: {
                    pubId: "6da09f566a9dc06",
                    ext: { placement_name: je[F.device]["970x250"] },
                  },
                },
                {
                  bidder: "richaudience",
                  params: { pid: Ue[F.device]["970x250"], supplyType: "site" },
                },
                {
                  bidder: "sharethrough",
                  params: { pkey: Le[F.device]["970x250"], bcat: Ot },
                },
                {
                  bidder: "triplelift",
                  params: { inventoryCode: Qe[F.device]["970x250"] },
                },
                {
                  bidder: "amx",
                  params: {
                    tagId: Ke[F.device]["970x250"],
                    adUnitId: We[F.device]["970x250"],
                  },
                },
                {
                  bidder: "yieldmo",
                  params: { placementId: $e[F.device]["970x250"] },
                },
                {
                  bidder: "unruly",
                  params: { siteId: Ze[F.device]["970x250"] },
                },
                {
                  bidder: "medianet",
                  params: { cid: "8CU2QB97K", crid: Xe[F.device]["970x250"] },
                },
                ...(vt()
                  ? [
                      {
                        ...
                        params: {
                          delDomain: "poki-d.openx.net",
                          unit: at[F.device]["970x250"],
                        },
                      },
                      {
                        bidder: "ix_s2s",
                        params: { siteId: it[F.device]["970x250"] },
                      },
                      {
                        bidder: "pubmatic_s2s",
                        params: {
                          publisherId: "156838",
                          adSlot: tt[F.device]["970x250"],
                          bcat: Ot,
                        },
                      },
                      {
                      ...
                      },
                      {
                        bidder: "richaudience_s2s",
                        params: {
                          pid: nt[F.device]["970x250"],
                          supplyType: "site",
                        },
                      },
                      {
                        bidder: "sharethrough_s2s",
                        params: { pkey: Je[F.device]["970x250"], bcat: Ot },
                      },
                      {
                        bidder: "triplelift_s2s",
                        params: { inventoryCode: Ye[F.device]["970x250"] },
                      },
                      {
                        bidder: "amx_s2s",
                        params: {
                          tagId: "yKyauEkOj",
                          adUnitId: `PBS_${We[F.device]["970x250"]}`,
                        },
                      },
                      {
                        bidder: "yieldmo_s2s",
                        params: { placementId: rt[F.device]["970x250"] },
                      },
                      {
                        bidder: "unruly_s2s",
                        params: { siteId: st[F.device]["970x250"] },
                      },
                      {
                        bidder: "medianet_s2s",
                        params: {
                          cid: "8CU2QB97K",
                          crid: ct[F.device]["970x250"],
                        },
                      },
                    ]
                  : []),
            ...
            },
            {
              ...
              bids: [
                ...
                { bidder: "ix", params: { siteId: ze[F.device]["160x600"] } },
                {
                  bidder: "pubmatic",
                  params: {
                    publisherId: "156838",
                ...
                },
                {
                  ...
                  params: {
                    pubId: "6da09f566a9dc06",
                    ext: { placement_name: je[F.device]["160x600"] },
                  },
                },
                {
                  bidder: "richaudience",
                  params: { pid: Ue[F.device]["160x600"], supplyType: "site" },
                },
                {
                  bidder: "sharethrough",
                  params: { pkey: Le[F.device]["160x600"], bcat: Ot },
                },
                {
                  bidder: "triplelift",
                  params: { inventoryCode: Qe[F.device]["160x600"] },
                },
                {
                  bidder: "amx",
                  params: {
                    tagId: Ke[F.device]["160x600"],
                    adUnitId: We[F.device]["160x600"],
                  },
                },
                {
                  bidder: "yieldmo",
                  params: { placementId: $e[F.device]["160x600"] },
                },
                {
                  bidder: "unruly",
                  params: { siteId: Ze[F.device]["160x600"] },
                },
                {
                  bidder: "medianet",
                  params: { cid: "8CU2QB97K", crid: Xe[F.device]["160x600"] },
                },
                ...(vt()
                  ? [
                      {
                        ...
                        params: {
                          delDomain: "poki-d.openx.net",
                          unit: at[F.device]["160x600"],
                        },
                      },
                      {
                        bidder: "ix_s2s",
                        params: { siteId: it[F.device]["160x600"] },
                      },
                      {
                        bidder: "pubmatic_s2s",
                        params: {
                          publisherId: "156838",
                          adSlot: tt[F.device]["160x600"],
                          bcat: Ot,
                        },
                      },
                      {
                      ...
                      },
                      {
                        bidder: "richaudience_s2s",
                        params: {
                          pid: nt[F.device]["160x600"],
                          supplyType: "site",
                        },
                      },
                      {
                        bidder: "sharethrough_s2s",
                        params: { pkey: Je[F.device]["160x600"], bcat: Ot },
                      },
                      {
                        bidder: "triplelift_s2s",
                        params: { inventoryCode: Ye[F.device]["160x600"] },
                      },
                      {
                        bidder: "amx_s2s",
                        params: {
                          tagId: "yKyauEkOj",
                          adUnitId: `PBS_${We[F.device]["160x600"]}`,
                        },
                      },
                      {
                        bidder: "yieldmo_s2s",
                        params: { placementId: rt[F.device]["160x600"] },
                      },
                      {
                        bidder: "unruly_s2s",
                        params: { siteId: st[F.device]["160x600"] },
                      },
                      {
                        bidder: "medianet_s2s",
                        params: {
                          cid: "8CU2QB97K",
                          crid: ct[F.device]["160x600"],
                        },
                      },
                    ]
                  : []),
            ...
            },
            {
              ...
              bids: [
                ...
                { bidder: "ix", params: { siteId: ze[F.device]["320x50"] } },
                {
                  bidder: "pubmatic",
                  params: {
                    publisherId: "156838",
                ...
                },
                {
                  ...
                  params: {
                    pubId: "6da09f566a9dc06",
                    ext: { placement_name: je[F.device]["320x50"] },
                  },
                },
                {
                  bidder: "richaudience",
                  params: { pid: Ue[F.device]["320x50"], supplyType: "site" },
                },
                {
                  bidder: "sharethrough",
                  params: { pkey: Le[F.device]["320x50"], bcat: Ot },
                },
                {
                  bidder: "triplelift",
                  params: { inventoryCode: Qe[F.device]["320x50"] },
                },
                {
                  bidder: "amx",
                  params: {
                    tagId: Ke[F.device]["320x50"],
                    adUnitId: We[F.device]["320x50"],
                  },
                },
                {
                  bidder: "yieldmo",
                  params: { placementId: $e[F.device]["320x50"] },
                },
                {
                  bidder: "unruly",
                  params: { siteId: Ze[F.device]["320x50"] },
                },
                {
                  bidder: "medianet",
                  params: { cid: "8CU2QB97K", crid: Xe[F.device]["320x50"] },
                },
                ...(vt()
                  ? [
                      {
                        ...
                        params: {
                          delDomain: "poki-d.openx.net",
                          unit: at[F.device]["320x50"],
                        },
                      },
                      {
                        bidder: "ix_s2s",
                        params: { siteId: it[F.device]["320x50"] },
                      },
                      {
                        bidder: "pubmatic_s2s",
                        params: {
                          publisherId: "156838",
                          adSlot: tt[F.device]["320x50"],
                          bcat: Ot,
                        },
                      },
                      {
                      ...
                      },
                      {
                        bidder: "richaudience_s2s",
                        params: {
                          pid: nt[F.device]["320x50"],
                          supplyType: "site",
                        },
                      },
                      {
                        bidder: "sharethrough_s2s",
                        params: { pkey: Je[F.device]["320x50"], bcat: Ot },
                      },
                      {
                        bidder: "triplelift_s2s",
                        params: { inventoryCode: Ye[F.device]["320x50"] },
                      },
                      {
                        bidder: "amx_s2s",
                        params: {
                          tagId: "yKyauEkOj",
                          adUnitId: `PBS_${We[F.device]["320x50"]}`,
                        },
                      },
                      {
                        bidder: "yieldmo_s2s",
                        params: { placementId: rt[F.device]["320x50"] },
                      },
                      {
                        bidder: "unruly_s2s",
                        params: { siteId: st[F.device]["320x50"] },
                      },
                      {
                        bidder: "medianet_s2s",
                        params: {
                          cid: "8CU2QB97K",
                          crid: ct[F.device]["320x50"],
                        },
                      },
                    ]
                  : []),
            ...
            },
            {
              ...
              bids: [
                ...
                { bidder: "sharethrough", params: { pkey: qe, bcat: Ot } },
                {
                  bidder: "triplelift",
                ...
                },
                {
                  ...
                  params: {
                    tagId: "yKyauEkOj",
                    adUnitId: `${We[F.device]["728x90"]}_external`,
                  },
                },
                {
                  bidder: "yieldmo",
            ...
            },
            {
              ...
              bids: [
                ...
                { bidder: "sharethrough", params: { pkey: He, bcat: Ot } },
                {
                  bidder: "triplelift",
                ...
                },
                {
                  ...
                  params: {
                    tagId: "yKyauEkOj",
                    adUnitId: `${We[F.device]["300x250"]}_external`,
                  },
                },
                {
                  bidder: "yieldmo",
            ...
            },
            {
              ...
              bids: [
                ...
                { bidder: "sharethrough", params: { pkey: Ve, bcat: Ot } },
                {
                  bidder: "triplelift",
                ...
                },
                {
                  ...
                  params: {
                    tagId: "yKyauEkOj",
                    adUnitId: `${We[F.device]["970x250"]}_external`,
                  },
                },
                {
                  bidder: "yieldmo",
            ...
            },
            {
              ...
              bids: [
                ...
                { bidder: "sharethrough", params: { pkey: Ge, bcat: Ot } },
                {
                  bidder: "triplelift",
                ...
                },
                {
                  ...
                  params: {
                    tagId: "yKyauEkOj",
                    adUnitId: `${We[F.device]["160x600"]}_external`,
                  },
                },
                {
                  bidder: "yieldmo",
            ...
            },
            {
              ...
              bids: [
                ...
                },
                {
                  ...
                  params: {
                    tagId: "yKyauEkOj",
                    adUnitId: `${We[F.device]["320x50"]}_external`,
                  },
                },
                {
                  bidder: "yieldmo",
        ...
        window.pbjs.que.push(() => {
          ...
          window.pbjs.addAdUnits(
            ((e, t) => {
              ...
              for (let t = 0; t <= e.length; t++) {
                const i = e[t],
                  o = n[i?.mediaTypes?.video ? "video" : "display"] || {};
                for (let n = (i?.bids?.length || 0) - 1; n >= 0; n--) {
                  const a = i.bids[n],
                    r = Math.random();
                  o[a.bidder] && r > o[a.bidder] && e[t].bids.splice(n, 1);
                }
              }
              return e;
            })(t.adUnits || s, i)
          ...
          const o = (e) => (t, i, n) => {
            if (n?.mediaTypes?.banner) {
              ["ix", "richaudience", "pubmatic", "sharethrough"].includes(e) &&
                (t *= 0.95);
            }
          ...
          (window.pbjs.bidderSettings = {
            ...
            openx: { bidCpmAdjustment: o("openx") },
            ix: { bidCpmAdjustment: o("ix") },
            richaudience: { bidCpmAdjustment: o("richaudience") },
            onetag: { bidCpmAdjustment: o("onetag") },
            rubicon: { bidCpmAdjustment: o("rubicon") },
            pubmatic: { bidCpmAdjustment: o("pubmatic") },
            sharethrough: { bidCpmAdjustment: o("sharethrough") },
            triplelift: { bidCpmAdjustment: o("triplelift") },
          }),
            window.pbjs.onEvent("bidAdjustment", (e) => {
              e &&
                (function (e) {
                  let t = e?.meta?.advertiserDomains?.find(Pe);
                  return (
                    !t &&
      ...
      qt = ["AU", "CA", "IE", "NZ", "US", "GB"];
    function Qt() {
      const { country: e } = F;
      return "US" === e ? 1.49 : qt.includes(e) ? 0.49 : 0.15;
    }
    async function Wt(t, i, n, o, a, r) {
      const s = L(),
        d = a ? "nope" : i,
        c = be(),
        l = o ? Me : Re;
        ...
        if ((A--, !(A > 0)))
          try {
            let o,
              A = d;
            if (Gt()) {
              Q.dispatchEvent(e.ads.prebidRequested, { blocked: Be() });
              const a = window.pbjs.adUnits.filter((e) => e.code === l)[0];
              if ("undefined" === a)
                return (
                  console.warn(
              ...
              if (o) {
                let e = o.meta?.advertiserDomains?.join(",");
                "richaudience" === o.bidderCode &&
                  (e = o.meta?.advertiserDomains?.[0]),
                  Q.addVideoDataAnnotations({
                    adID: o.adId,
                    adDomain: e,
                    HBAdDomain: e,
                    HBBidder: o.bidderCode,
                    HBAdId: o.adId,
                    HBCreativeId: o.creativeId,
                    HBSource: o.source,
                    HBCPM: o.cpm,
                  }),
                  Math.random() < 0.01 &&
                    Q.addVideoDataAnnotations({
                      HBVastXML: JSON.stringify(o.vastXml),
                      HBVastUrl: o.vastUrl,
                    });
              }
            }
            if (p) {
              ...
              ("8iam0w" === t && ("mobile" === s || "tablet" === s)) ||
                ...
                Q.addVideoDataAnnotations({ APSBidder: Se(t) });
            }
            if (a) {
              if (p) {
                const e = (function (e) {
                  ...
                  return n
                    ? {
                        bid: n,
                        vast: `https://aax.amazon-adsystem.com/e/dtb/vast?b=${D(
                          "amzniid",
                          t
                        )}&rnd=${Math.round(1e10 * Math.random())}&pp=${i}`,
                      }
                    : null;
                })(p);
                e &&
                  (!o || !o.videoCacheKey || o.cpm < e.bid) &&
                  (o = {
                    cpm: e.bid,
                    vast: e.vast,
                    bidder: "amazon",
              ...
              if (
                (1 === r ||
                  (o && o.videoCacheKey && !(o.cpm < Qt())) ||
                  (o = {
                    cpm: Qt(),
                    vast: "https://api.poki.com/ads/houseads/video/vast",
                    bidder: "poki",
                    videoCacheKey: "poki",
                  }),
                !o || !o.videoCacheKey)
              ...
              switch (o.bidder) {
                case "onetag":
                  A = `https://onetag-sys.com/invocation/?key=${o.videoCacheKey}`;
                  break;
                case "rubicon":
                  A = `https://prebid-server.rubiconproject.com/cache?uuid=${o.videoCacheKey}`;
                  break;
                case "spotx":
                  A = `https://search.spotxchange.com/ad/vast.html?key=${o.videoCacheKey}`;
                  break;
                case "amazon":
                case "poki":
                  A = o.vast;
                  break;
                default:
                  A = `https://prebid.adnxs.com/pbc/v1/cache?uuid=${o.videoCacheKey}`;
              }
              W({ event: "video-ready", bidder: o?.bidder, bid: o?.cpm }),
                Q.addVideoDataAnnotations({
                  p4d_game_id: F.gameID,
                  p4d_version_id: F.versionID,
                  bidder: o?.bidder,
            ...
            Q.addVideoDataAnnotations({ pokiAdServer: a, adTagUrl: A }),
              o
                ? Q.addVideoDataAnnotations({
                    prebidBidder: o?.bidder,
                    prebidBid: o?.cpm,
                  })
                : Q.addVideoDataAnnotations({
                    prebidBidder: void 0,
      ...
      if ((Ft("video") && A++, Gt() && A++, Ft("video")))
        try {
          let e = "desktop_ingame_midroll_1";
          o &&
            (e =
              "desktop" === s
                ? "desktop_ingame_roll_1"
                : "mobile_ingame_roll_1");
          let t = [{ slotID: e, mediaType: "video" }];
          bt() && (t = window?.assertive?.addAmazonFloors?.(t)),
            window.apstag.fetchBids({ slots: t, timeout: 1500 }, (e) => {
              e.length > 0 && (p = e[0].encodedQsParams), u();
            });
        } catch {
          u();
        }
      a && W({ event: "video-request" }),
        Gt() &&
          window.pbjs.que.push(() => {
            const e = (function (e) {
                if (ft() && ht?.contentWindow?.floorModuleLoaded)
    ...
    let Zt = !1,
      Xt = !1,
      Yt = null;
    const { testVideos: Jt, device: ei } = F,
      ti = { log: () => {}, error: () => {}, warn: () => {}, info: () => {} },
      ii = () =>
        F.videoAdDebug?.breakVideoFlow
          ? "junk"
          : (ti.log("Getting ad unit path", {
              testVideos: Jt,
              device: ei,
              siteID: F.siteID,
            }),
            Jt
              ...
              : `/21682198607/${ei}_ingame_rewarded_google/${F.siteID}_${ei}_ingame_rewarded_google`),
      ni = () => {
        if (Yt) return;
        if (((Yt = $t("poki-rewarded-web-iframe")), !Yt)) return;
        const e = Yt.contentWindow?.document;
        e &&
          (e.open(),
          e.write(
            `\n\t\t<!DOCTYPE html>\n\t\t<html>\n\t\t<head>\n\t\t\t<script async src="https://securepubads.g.doubleclick.net/tag/js/gp.js"><\/script>\n\t\t\t<style>\n\t\t\t\tbody { margin: 0; padding: 0; overflow: hidden; }\n\t\t\t\tiframe { width: 100%; height: 100%; border: none; }\n\t\t\t</style>\n\t\t</head>\n\t\t<body>\n\t\t\t<script>\n\t\t\t\t(${(() => {
      ...
      oi = (t) => {
        ti.log("Starting backfill", { criteria: t }),
          ni(),
          te.track(e.tracking.ads.rewardedWeb.request),
          ((t) => {
            ti.log("Initializing rewarded slot", { criteria: t }),
              Yt?.contentWindow
                ? (Yt.contentWindow.postMessage(
                  ...
                  ti.log("Posted init message to iframe"),
                  setTimeout(() => {
                    Xt ||
                      (ti.log(
                ...
                : ti.log("No iframe content window available");
          })(t);
      },
      ai = (e) => {
        Yt &&
          ((Yt.style.visibility = e ? "visible" : "hidden"),
          (Yt.style.pointerEvents = e ? "auto" : "none"));
      };
    let ri = !1,
      si = null;
    const { testVideos: di, device: ci } = F,
      li = { log: () => {}, error: () => {}, warn: () => {}, info: () => {} },
      pi = () =>
        F.videoAdDebug?.breakVideoFlow
          ? "junk"
          : (li.log("Getting ad unit path", {
              testVideos: di,
              device: ci,
              siteID: F.siteID,
            }),
            di
              ...
              : `/21682198607/${ci}_ingame_interstitial_google/${F.siteID}_${ci}_ingame_interstitial_google`),
      Ai = (e) => {
        si &&
          ((si.style.visibility = e ? "visible" : "hidden"),
          (si.style.pointerEvents = e ? "auto" : "none"));
      },
      mi = () => {
        if (si) return;
        if (((si = $t("poki-interstitial-web-iframe")), !si)) return;
        const e = si.contentWindow?.document;
        e &&
          (e.open(),
          e.write(
                ...
                window.googletag.cmd.push(() => {
                  window.parent.postMessage(
                    ...
                    window.googletag
                      ...
                      .addEventListener("slotRequested", (e) => {
                        window.parent.postMessage(
                          { type: "interstitialSlotRequested", hasEvent: !!e },
                          "*"
                        );
                      });
                }),
                    ...
                    window.googletag.cmd.push(() => {
                      ...
                      window.googletag.defineOutOfPageSlot &&
                        ...
                        Object.keys(t).forEach((e) => {
                          const i = t[e];
                          "" !== i &&
                            window.googleInterstitialSlot?.setTargeting?.(e, i);
                        }),
      ...
      ui = (t) => {
        li.log("Starting backfill", { criteria: t }),
          mi(),
          ((t) => {
            li.log("Initializing interstitial slot", { criteria: t }),
              si?.contentWindow
                ? (si.contentWindow.postMessage(
                    {
                  ...
                  li.log("Posted init message to iframe"),
                  setTimeout(() => {
                    ri ||
                      (li.log(
                ...
                : li.log("No iframe content window available");
          })(t);
      },
      gi = {
        desktop: {
          [lt]: {
            [ut.skyscraper]: ["DZ", "BO", "BD", "TN"],
            [ut.rectangle]: ["CN", "BO", "BD", "NP", "TN", "DZ"],
            [ut.leaderboard]: ["CN", "NP", "PY", "DZ", "BO", "TN"],
            [ut.midroll]: ["CN", "PK", "DZ"],
            [ut.rewarded]: ["CN", "DZ"],
          },
          [pt]: { [ut.leaderboard]: ["DZ"] },
        },
        mobile: {
          [lt]: {
            [ut.gamebar]: [
          ...
          [pt]: { [ut.smallLeaderboard]: ["DZ"] },
        },
      };
    function hi(e = "", t = mt()) {
      const { device: i, country: n } = F,
        o = ((e) => {
          if (e.includes("gamebar_320x50")) return ut.gamebar;
          if (e.includes(`external_${F.device}_display_platform`))
            return ut.externalSkyscraper;
          const t = Object.keys(ut).find((t) => !!e.includes(`_${ut[t]}`));
          return t && "gamebar" !== t
            ? t
            : (console.warn(
    ...
    function fi() {
      return (
        ...
        (void 0 === vi &&
          ((vi =
            wi.includes(F.country.toUpperCase()) &&
            (function (e) {
              let t = 0;
              for (let i = 0; i < e.length; i++)
          ...
          te.track(e.tracking.ads.h5GamingEnabled, { enabled: vi })),
        vi)
      );
    }
    class bi {
      ...
      constructor(t, i = {}) {
        (this.#i = t),
          (this.#d = Kt()),
          (this.totalRetries = i.totalRetries || ve.waterfallRetries || 1),
          (this.timing = i.timing || new fe(ve.adTiming)),
          fi() && (this.totalRetries = 0),
          Q.addEventListener(e.ads.video.error, () => {
      ...
      moveThroughWaterfall() {
        ...
        !1 !== this.#r &&
          (this.timing.stopWaterfallTimer(),
          this.#a < this.totalRetries
            ? this.requestAd()
            : ((this.#r = !1), this.startBackfill()));
      }
      startBackfill() {
        this.#l === e.ads.position.rewarded ? oi(this.#o) : ui(this.#o);
      }
      cutOffWaterfall() {
        this.#i.tearDown(), this.moveThroughWaterfall();
      }
      startHouseAdFlow() {
        const e = "https://api.poki.com/ads/houseads/video/vast";
        Q.addVideoDataAnnotations({
          pokiAdServer: !0,
          adTagUrl: e,
          bidder: "poki",
      ...
      start(t = {}, i) {
        (this.#r = !0),
          ...
          (this.#n = ((t) => {
            const { device: i } = F;
            let n = "midroll";
            if (D("noFill") || V.debug) return ["junk", "junk"];
            t === e.ads.position.rewarded && (n = "rewarded");
            const o = "/21682198607/";
            return mt() === At
              ? [
                  `${o}external_${i}_video_1/external_${i}_ingame_${n}_1`,
                  `${o}external_${i}_video_2/external_${i}_ingame_${n}_2`,
                ]
              : [
                  `${o}${i}_ingame_${n}_1/${F.siteID}_${i}_ingame_${n}_1`,
                  `${o}${i}_ingame_${n}_2/${F.siteID}_${i}_ingame_${n}_2`,
                ];
          })(i)),
          (this.#l = i),
          this.requestAd();
      ...
      requestAd() {
        this.timing.startWaterfallTimer(() => {
          ...
          this.#a++,
          (this.#o.waterfall = this.#a),
          (this.#c = !1);
        const t = (this.#a - 1) % this.#n.length,
          i = this.#n[t];
        ...
        (this.#o.ay_hb_house = 1),
          (this.#o.billboards_fit = o ? "yes" : "no"),
          (this.#o.page_has_lead =
            null !==
        ...
        Q.addVideoDataAnnotations({
          ...
          F.googlePreview
            ? (K(
                `requesting video ad for google preview (${this.#a}/${
                  this.totalRetries
                } tries)`
              ),
              this.#i.requestAd(a))
            : V.debug || F.houseAdsOnly
            ? (K(
                `requesting video ad in house-ad mode (${this.#a}/${
                  this.totalRetries
                } tries)`
              ),
              this.startHouseAdFlow())
            : this.#d
            ? (K(
                `requesting video ad with Poki Adserver (${this.#a}/${
                  this.totalRetries
                } tries)`
              ),
              Wt(this.#i, a, this.#o, this.#s, !0, this.#a))
            : fi()
            ? (this.timing.stopWaterfallTimer(),
              (this.#r = !1),
              this.startBackfill())
            : r && 1 === this.#a
            ? (K(
                `requesting video ad with Prebid Video enabled (${this.#a}/${
                  this.totalRetries
                } tries)`
              ),
              Wt(this.#i, a, this.#o, this.#s, !1, this.#a))
            : (K(
                `requesting video ad in plain mode (${this.#a}/${
                  this.totalRetries
                } tries)`
              ),
              this.#i.requestAd(a));
    ...
    class yi {
      ...
      queueFakeProgress(e, t, i) {
        this.#h.push({ progressToFake: e, duration: t, stopEvent: i }),
          Q.addEventListener(i, (t) => {
            if (-1 === t?.duration) return this.reset(), void this.#p(0);
            (this.#A[i] = !0),
              (this.currentProgress = this.#m + e),
              (this.#m = this.currentProgress),
              this.#p(this.currentProgress),
              this.#w.shift(),
              this.#w.length > 0 ? this.continue() : this.pause();
          });
      }
      fakeProgress(e, t, i) {
        this.#w.push({ progressToFake: e, duration: t, stopEvent: i }),
          (this.#b = !0),
          this.continue();
      }
      start() {
        this.#w.length > 0 ||
          ((this.#w = [...this.#h]), (this.#f = !0), this.continue());
      }
      continue() {
        if (this.#w.length > 0 && !this.#g) {
          this.#u = Date.now();
          const e = 50;
      ...
      initializeNoProgressFix() {
        Q.addEventListener(e.ads.started, (t) => {
          ...
          Q.addEventListener(e.ads.video.progress, () => {
            this.#v && (clearTimeout(this.#v), (this.#v = 0));
          });
      }
      reset() {
        (this.#A = {}),
    ...
    const ki = "pokiSdkContainer",
      xi = "pokiSdkFixed",
      _i = "pokiSdkOverlay",
      Ii = "pokiSdkHidden",
      Si = "pokiSdkInsideContainer",
      Ei = "pokiSdkPauseButtonContainer",
      Ci = "pokiSdkPauseButton",
      Pi = "pokiSdkPauseButtonBG",
      Bi = "pokiSdkStartAdButton",
      Ti = "pokiSdkProgressBar",
      Di = "pokiSdkProgressContainer",
      Mi = "pokiSdkSpinnerContainer",
      Ri = "pokiSdkVideoContainer",
      Li = "pokiSdkVisible",
      Oi = "pokiSDKAdContainer",
      Ni = "pokiSDKHouseAdContainer",
      zi = "pokiSDKNrAdsContainer",
      Ui = `\n.${ki} {\n\toverflow: hidden;\n\tposition: absolute;\n\tleft: 0;\n\ttop: 0;\n\twidth: 100%;\n\theight: 100%;\n\tz-index: 99999;\n\tdisplay: flex;\n\talign-items: center;\n\tjustify-content: center;\n}\n\n.${ki}.${xi} {\n\tposition: fixed;\n}\n\n.${ki}.${Li} {\n\tdisplay: block;\n}\n\n.${ki}.${Ii},\n.${Mi}.${Ii} {\n\tdisplay: none;\n}\n\n.${ki}.${Ii},\n.${Mi} {\n\tpointer-events: none;\n}\n\n.${Mi} {\n\tz-index: 10;\n\tposition: absolute;\n\ttop: 0;\n\tleft: 0;\n\twidth: 100%;\n\theight: 100%;\n\tbackground: url('https://a.poki-cdn.com/images/thumb_anim_2x.gif') 50% 50% no-repeat;\n\tuser-select: none;\n}\n\n.${Si} {\n\tbackground: #000;\n\tposition: relative;\n\tz-index: 1;\n\twidth: 100%;\n\theight: 100%;\n\tdisplay: flex;\n\tflex-direction: column;\n\tjustify-content: center;\n\n\topacity: 0;\n\t-webkit-transition: opacity 0.5s ease-in-out;\n\t-moz-transition: opacity 0.5s ease-in-out;\n\t-ms-transition: opacity 0.5s ease-in-out;\n\t-o-transition: opacity 0.5s ease-in-out;\n\ttransition: opacity 0.5s ease-in-out;\n}\n\n.${ki}.${Li} .${Si} {\n\topacity: 1;\n}\n\n.${Oi}, .${Ri} {\n\tposition: absolute;\n\twidth: 100%;\n\theight: 100%;\n}\n\n.${Bi} {\n\tposition: absolute;\n\tz-index: 9999;\n\ttop: 0;\n\n\tpadding-top: 10%;\n\twidth: 100%;\n\theight: 100%;\n\ttext-align: center;\n\tcolor: #FFF;\n\n\tfont: 700 15pt 'Arial', sans-serif;\n\tfont-weight: bold;\n\tletter-spacing: 1px;\n\ttransition: 0.1s ease-in-out;\n\tline-height: 1em;\n}\n\n.${Ei} {\n\tcursor:pointer;\n\twidth: 100%;\n\theight: 100%;\n\tz-index: 10;\n}\n\n.${Pi} {\n    content: '';\n    background: rgba(0, 43, 80, 0.5);\n    display: block;\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n\tz-index: 11;\n}\n\n.${Ei}:hover .${Pi} {\n\tbackground: rgba(0, 43, 80, 0.7);\n}\n\n.${Ci} {\n\tposition: absolute;\n    top: 50%;\n    left: 50%;\n    z-index: 12;\n}\n\n.${Ci}:before {\n\tcontent: '';\n\tposition: absolute;\n\twidth: 100px;\n\theight: 100px;\n\tdisplay: block;\n\tborder: 2px solid #fff;\n\tborder-radius: 50%;\n\tuser-select: none;\n\tbackground-color: rgba(0, 0, 0, 0.6);\n\ttransition: background-color 0.5s ease;\n\tanimation: 1s linear infinite pokiPulse;\n\tz-index: 12;\n}\n\n.${Ci}:after {\n\tcontent: '';\n\tposition: absolute;\n\tdisplay: block;\n\tbox-sizing: border-box;\n\tborder-color: transparent transparent transparent #fff;\n\tborder-style: solid;\n\tborder-width: 26px 0 26px 40px;\n\tpointer-events: none;\n\tanimation: 1s linear infinite pokiPulse;\n\tleft: 6px;\n\tz-index: 12;\n}\n\n@keyframes pokiPulse {\n\t0% {\n\t\ttransform: translate(-50%, -50%) scale(0.95);\n\t}\n\t70% {\n\t\ttransform: translate(-50%, -50%) scale(1.1);\n\t}\n\t100% {\n\t\ttransform: translate(-50%, -50%) scale(0.95);\n\t}\n}\n\n.${Di} {\n\tbackground: #B8C7DD;\n\twidth: 100%;\n\theight: 5px;\n\tposition: absolute;\n\tbottom: 0;\n\tz-index: 9999;\n}\n\n.${Ti} {\n\tposition:relative;\n\tbottom:0px;\n\tbackground: #FFDC00;\n\theight: 100%;\n\twidth: 0%;\n\ttransition: width 0.5s;\n\ttransition-timing-function: linear;\n}\n\n.${Ti}.${Li}, .${Ei}.${Li}, .${Bi}.${Li} {\n\tdisplay: block;\n\tpointer-events: auto;\n}\n\n.${Ti}.${Ii}, .${Ei}.${Ii}, .${Bi}.${Ii}, .${zi}.${Ii} {\n\tdisplay: none;\n\tpointer-events: none;\n}\n\n.${Oi} .${Ni} {\n\tposition: absolute;\n\twidth: 100%;\n\theight: 100%;\n\tz-index: 99999;\n\tcursor: pointer;\n}\n\n.${zi} {\n\tbottom: 10px;\n\tposition: absolute;\n\tleft: 10px;\n\tz-index: 9999;\n\tcolor: #FFF;\n\tfont: 700 9pt 'Arial', sans-serif;\n\tfilter: drop-shadow(0 0 0.2rem black);\n}\n\n`;
    let ji;
    async function Fi() {
      if (
        "undefined" != typeof navigator &&
        ...
        return !0;
      if (!ji) {
        (ji = document.createElement("video")),
          ji.setAttribute("playsinline", "playsinline");
      ...
      try {
        return await ji.play(), !0;
      } catch {
        return !1;
      }
    }
    function Gi(e) {
      e.classList.add(Ii), e.classList.remove(Li);
    }
    function Vi(e) {
      e.classList.add(Li), e.classList.remove(Ii);
    }
    class Hi {
      #y;
      #k;
      ...
      constructor(t) {
        if (
          ((this.#M = new yi((e) => this.updateProgressBar(e))),
          this.#M.queueFakeProgress(20, 2e3, e.ads.started),
          this.#O(t.wrapper),
          "undefined" != typeof window && document)
        ) {
          const e = document.createElement("style");
          (e.innerHTML = Ui), document.head.appendChild(e);
        }
      }
      updateProgressBar(e) {
      ...
      async startNonIMAFallbackVideo(t) {
        ...
        this.#x.addEventListener("click", o);
        const a = (t) => {
          (this.#R = void 0),
            this.hide(),
            this.#x.removeChild(i),
            this.#x.removeEventListener("click", o),
        ...
        Fi() || (i.muted = !0), i.play().catch(() => a());
      }
      setNrAds(e, t) {
        1 !== t
          ? (Vi(this.#L), (this.#L.innerHTML = `Ad ${e} of ${t}`))
          : Gi(this.#L);
      }
    }
    class qi {
            ...
            Q.dispatchEvent(e.ads.impression, {
              ...
              (function () {
                const t = Q.getVideoDataAnnotations(),
                  ...
                  c = n === e.ads.position.rewarded ? Me : Re;
                if (o) return;
                let l;
                if (i)
                  try {
      ...
      onAdLoaderError(t) {
        ...
        const i = t?.getError(),
          ...
          o = i?.getErrorCode() || 0;
        Q.dispatchEvent(e.ads.video.loaderError, { message: n, errorCode: o });
      }
      onAdError(t) {
        this.tearDown();
        const i = t?.getError(),
    ...
    const Qi = () => {
      ...
      return ke(
        `https://devs-api.poki.com/gameinfo/@sdk?href=${encodeURIComponent(
          `${window.location.protocol}//${window.location.host}${e}${window.location.search}`
        )}&referrer=${t}`,
    ...
    async function Ki() {
      if ("test" === window?.process?.env?.NODE_ENV)
        return { blocklist: [], countryExclusion: [], bidderLimitation: {} };
      try {
        const e = { "Content-Type": "application/json" },
          t = await ke("https://api.poki.com/ads/settings", {
            method: "GET",
            headers: e,
          }),
          {
        ...
        return (
          F.country &&
            ((a[F.country] = a[F.country] || {}),
            (a[F.country].video = a[F.country].video || {}),
            (a[F.country].video.triplelift = 0.05)),
          {
            blocklist: i?.split(/[\r\n]+/) || [],
    ...
    class $i {
          ...
          window.googletag.pubads().addEventListener("slotRenderEnded", (t) => {
            ...
            try {
              ...
              (p = n.pbjsTargetting || {}),
                ...
                (u = ((e) => {
                  let t = { cpm: 0 };
                  if (void 0 === window.pbjs || !Gt()) return t;
            ...
            let w = parseFloat(p.hb_pb);
            Number.isNaN(w) && (w = void 0);
            const v = {
              size: n.size,
            ...
            g && n.backfillHouseads
              ? this.requestHouseAd(n, v)
              : (n.onDisplayRendered && n.onDisplayRendered(g),
                te.track(e.tracking.ads.display.impression, v));
          }),
            window.googletag
              .pubads()
              .addEventListener("impressionViewable", (t) => {
                const i = t.slot.getSlotElementId();
                (t?.slot?.getAdUnitPath()?.includes("ingame_rewarded_google") ||
                  t?.slot?.getAdUnitPath()?.includes("sanghan_rweb_ad_unit")) &&
      ...
      getDisplaySlotConfig(e, t, i) {
        const n = t.split("x").map((e) => parseInt(e, 10)),
          o = this.getDisplaySlotID(e);
        if (o) {
          const t = this.slotMap.get(o);
          if (t && t.width === n[0] && t.height === n[1])
        ...
        return (
          (s.id = r),
          (s.className = "poki-ad-slot"),
          (s.style.width = `${n[0]}px`),
          (s.style.height = `${n[1]}px`),
          (s.style.overflow = "hidden"),
          (s.style.position = "relative"),
          s.setAttribute("data-poki-ad-size", t),
          {
            id: r,
            adUnitPath: a,
            size: t,
      ...
      renderAd(e) {
        const {
          ...
          A = this.getDisplaySlotConfig(t, i, a);
        (A.backfillHouseads = c),
          (A.criteria = o),
          (A.platformAd = l),
          this.slotMap.set(A.id, A),
          (A.opportunityId = n),
          (A.headerBiddingAllowed = p),
          (A.duringGameplay = "function" == typeof r ? r() : r),
          (A.onDisplayRendered = d),
          (A.onCanDestroy = s);
        let m = null;
        A.refreshNumber > 0 && (m = A.innerAdContainer),
          m ||
            (t.appendChild(A.innerAdContainer),
            t.setAttribute("data-poki-ad-id", A.id));
        const u = () => {
          setTimeout(() => {
            this.callOnCanDestroy(A.id);
          }, 6e3),
            V.debug || F.houseAdsOnly
              ? this.requestHouseAd(A, {
                  opportunityId: A.opportunityId,
                  refresh: A.refreshNumber > 0,
                  refreshNumber: A.refreshNumber,
                  refreshType: A.criteria?.refreshType || "",
                  duringGameplay: A.duringGameplay,
                  adUnitPath: A.adUnitPath,
                  platformAd: A.platformAd,
                })
              : window.googletag.cmd.push(() => {
                  const e = this.slotMap.get(A.id);
                  e &&
                    e.opportunityId === n &&
                    (this.totalRefreshNumber[A.adUnitPath] ||
                      (this.totalRefreshNumber[A.adUnitPath] = 0),
                    this.setupGPT(A, {
                      ...o,
                      refresh_number: `${A.refreshNumber || 0}`,
                      total_refresh_number: `${
                        this.totalRefreshNumber[A.adUnitPath]
                      }`,
                      ...("mobile" === F.device
                        ? {
        ...
        A.intersectionObserver?.disconnect();
        a.includes("mobile_gamebar_320x50")
          ? u()
          : ((A.intersectionObserver = new window.IntersectionObserver(
              ([e]) => {
                e.isIntersecting && (A.intersectionObserver?.disconnect(), u());
              },
              { threshold: 0.5 }
            )),
            A.intersectionObserver.observe(A.innerAdContainer));
      }
      setupGPT(e, t) {
        e.gptSlot ||
          (160 === e.width && 600 === e.height
            ? (e.gptSlot = window.googletag
                .defineSlot(e.adUnitPath, [[e.width, e.height], "fluid"], e.id)
                .addService(window.googletag.pubads()))
        ...
        if (n) {
          for (
            n.onCanDestroy &&
              ...
              Z("PokiSDK.destroyAd() called without waiting for onCanDestroy"),
      ...
      requestHouseAd = (t, i) => {
        ...
        W({ ...o, event: "request" }),
          ke(`https://api.poki.com/ads/houseads/display/${n}`)
            .then((e) => e.json())
            .then((n) => {
              const a = `<img draggable="false" src="${n.asset}" alt="house ad" style="display:block; margin:0 auto;" />`;
              let r = a;
              F.isPokiExternal &&
                n.click_through_url &&
                (r = `<a href="${n.click_through_url}" target="_blank" rel="noopener noreferrer">${a}</a>`),
                (t.innerAdContainer.innerHTML = r),
                t.onDisplayRendered && t.onDisplayRendered(!0),
                (i.houseAdId = n.id),
                (i.isEmpty = !1),
                te.track(e.tracking.ads.display.impression, i),
                W({ ...o, event: "impression" }),
                setTimeout(() => {
                  W({ ...o, event: "viewable" });
                }, 1e3);
            })
    ...
    class Zi extends $i {
      requestAd = (e) => {
        ...
        Ft() || Gt() || ((e.pbjsTargetting = {}), (e.amznTargetting = {}), i());
      };
      allBidsBack(t) {
        ...
        o.appendChild(n);
        const a = n?.contentWindow?.document;
        if (!a)
          return (
            console.error(
            ...
            void this.clearAd(o.parentNode)
          );
        let r = !0,
          s = i.pbjsTargetting.hb_bidder,
          d = parseFloat(i.pbjsTargetting.hb_pb);
        Number.isNaN(d) && (d = 0);
        const c = ((l = i?.amznTargetting?.amznbid), _e[l] || 0);
        var l;
        c > d
          ? ((s = Se(i?.amznTargetting?.amnzp)),
            (d = c),
            (r = !1),
            this.renderAMZNAd(i.id, o, a))
          : this.renderPrebidAd(i.id, o, a);
        const p = !s;
        te.track(e.tracking.ads.display.impression, {
          ...
          p
            ...
            : ((i.intersectionObserver = new IntersectionObserver(
              ...
              i.intersectionObserver.observe(o));
      }
    ...
    const dn = (() => {
      ...
      return () => (
        (e += 1),
        `u${`0000${(((36 * Math.random()) ** 4) | 0).toString(36)}`.slice(
          -4
        )}${e}`
      );
    })();
    ...
    const pn = (e, t) => {
        ...
        return null !== i && (i.constructor.name === t.name || pn(i, t));
      },
      An = new Set([
        "cx",
        "cy",
      ...
      mn = { html: void 0, svg: void 0 };
    function un(e, t = {}) {
      const i = pn(e, SVGElement) ? "svg" : "html",
        n = mn[i];
      if (n) return n;
      const o =
          t.includeStyleProperties ??
          cn(window.getComputedStyle(document.documentElement)),
        a = "html" === i ? o.filter((e) => !An.has(e)) : [...o];
      return (mn[i] = a), a;
    }
    function gn(e, t) {
    ...
    function hn(e, t = {}) {
      return {
        width:
          t.width ||
          (function (e) {
            const t = gn(e, "border-left-width"),
              i = gn(e, "border-right-width");
            return e.clientWidth + t + i;
          })(e),
        height:
          t.height ||
          (function (e) {
            const t = gn(e, "border-top-width"),
              i = gn(e, "border-bottom-width");
    ...
    function bn(e, t, i, n) {
      const o = `.${e}:${t}`,
        a = i.cssText
          ...
          : (function (e, t) {
              return un(document.documentElement, t)
                .map(
                  (t) =>
                    `${t}: ${e.getPropertyValue(t)}${
    ...
    function yn(e, t, i, n) {
      const o = window.getComputedStyle(e, i),
      ...
      s.appendChild(bn(r, i, o, n)), t.appendChild(s);
    }
    const kn = "application/font-woff",
      xn = "image/jpeg",
      _n = {
        woff: kn,
        woff2: kn,
    ...
    async function Tn(e, t) {
      return pn(e, HTMLCanvasElement)
        ? (async function (e) {
            try {
              if (e.getContext("2d")) return vn(e.toDataURL());
            } catch {}
            if (0 === e.width || 0 === e.height) return vn("data:,");
            const t = document
                ...
                try {
                  requestAnimationFrame(() => {
                    ...
                    o.bindTexture(o.TEXTURE_2D, a),
                      ...
                      o.deleteTexture(a),
                      o.deleteFramebuffer(r);
                    const s = o.getExtension("WEBGL_lose_context");
        ...
        ? (async function (e, t) {
            ...
            const { poster: i } = e,
              n = In(i);
            return vn(await Bn(i, n, t));
          })(e, t)
        : pn(e, HTMLIFrameElement)
        ? (async function (e, t) {
            try {
              if (e?.contentDocument?.body)
                return await On(e.contentDocument.body, t, !0);
            } catch {}
            return e.cloneNode(!1);
          })(e, t)
        : e.cloneNode(Mn(e));
    }
    const Dn = (e) => "SLOT" === e.tagName?.toUpperCase(),
      Mn = (e) => null != e.tagName && "SVG" === e.tagName.toUpperCase();
    function Rn(e, t, i) {
      return (
        (function (e, t, i) {
          const n = t.style;
          ...
          o.cssText
            ...
            : un(e, i).forEach((i) => {
                ...
                if ("font-size" === i && a.endsWith("px")) {
                  const e =
                    Math.floor(parseFloat(a.substring(0, a.length - 2))) - 0.1;
                  a = `${e}px`;
                }
                pn(e, HTMLIFrameElement) &&
                  "display" === i &&
                  ...
                  n.setProperty(i, a, o.getPropertyPriority(i));
              });
        })(e, t, i),
        pn(e, HTMLElement) &&
        pn(t, HTMLElement) &&
        ((function (e, t) {
          pn(e, HTMLTextAreaElement) && (t.innerHTML = e.value),
            pn(e, HTMLInputElement) && t.setAttribute("value", e.value);
        })(e, t),
        (function (e, t) {
          if (pn(e, HTMLSelectElement)) {
            const i = t,
        ...
        (function (e, t, i) {
          yn(e, t, ":before", i), yn(e, t, ":after", i);
        })(e, t, i),
        i.patchScroll)
          ? (function (e, t) {
              ...
              for (let i = 0; i < t.children.length; i += 1) {
                ...
                (a.a = 1),
                  ...
                  (a.c = 0),
                  (a.d = 1),
                  a.translateSelf(-e.scrollLeft, -e.scrollTop),
                  (a.a = r),
                  (a.b = s),
                  (a.c = d),
                  (a.d = c),
                  (n.style.transform = a.toString());
              }
              return t;
            })(e, t)
          : t
            ...
            Promise.resolve(e)
              ...
              .then((i) =>
                (async function (e, t, i) {
                  ...
                  return (
                    (n =
                      Dn(e) && e.assignedNodes
                        ? cn(e.assignedNodes())
                        : pn(e, HTMLIFrameElement) && e.contentDocument?.body
                        ? cn(e.contentDocument.body.childNodes)
                        : cn(
              ...
              .then((e) =>
                (async function (e, t) {
                  ...
                  for (let o = 0; o < i.length; o++) {
                    const a = i[o].getAttribute("xlink:href");
                    if (a) {
                      const i = e.querySelector(a),
                        o = document.querySelector(a);
                      i || !o || n[a] || (n[a] = await On(o, t, !0));
                    }
                  }
    ...
    const Nn = /url\((['"]?)([^'"]+?)\1\)/g,
      zn = /url\([^)]+\)\s*format\((["']?)([^"']+)\1\)/g,
      Un = /src:\s*(?:url\([^)]+\)\s*format\([^)]+\)[,;]\s*)+/g;
    async function jn(e, t, i, n, o) {
      try {
        const a = i
            ? (function (e, t) {
    ...
    async function Gn(e, t, i) {
      ...
      const n = (function (e, { preferredFontFormat: t }) {
        ...
        o = (function (e) {
          const t = [];
          return (
            e.replace(Nn, (e, i, n) => (t.push(n), e)), t.filter((e) => !Sn(e))
          );
        })(n);
      return o.reduce(
        (e, n) => e.then((e) => jn(e, n, t, i)),
        Promise.resolve(n)
      );
    }
    ...
    async function Hn(e, t) {
      ln(e) &&
        (await (async function (e, t) {
          (await Vn("background", e, t)) ||
            (await Vn("background-image", e, t)),
            (await Vn("mask", e, t)) || (await Vn("mask-image", e, t));
        })(e, t),
        await (async function (e, t) {
          const i = pn(e, HTMLImageElement),
            n = pn(e, SVGImageElement);
          if ((!i || Sn(e.src)) && (!n || Sn(e.href.baseVal))) return;
          const o = i ? e.src : e.href.baseVal,
            a = await Bn(o, In(o), t);
          await new Promise((t, n) => {
            ...
            o.decode && (o.decode = t),
              ...
              i ? ((e.srcset = ""), (e.src = a)) : (e.href.baseVal = a);
          });
        })(e, t),
        await (async function (e, t) {
          const i = cn(e.childNodes).map((e) => Hn(e, t));
    ...
    async function Qn(e) {
      ...
      return (t = { url: e, cssText: await i.text() }), (qn[e] = t), t;
    }
    async function Wn(e, t) {
      let { cssText: i } = e;
      const n = /url\(["']?([^"')]+)["']?\)/g,
        o = (i.match(/url\([^)]+\)/g) || []).map(async (o) => {
          let a = o.replace(n, "$1");
          return (
            ...
            Cn(
              a,
              t.fetchRequestInit,
              ({ result: e }) => ((i = i.replace(o, `url(${e})`)), [o, e])
            )
          );
        });
    ...
    async function $n(e, t) {
      ...
      const i = cn(e.ownerDocument.styleSheets),
      ...
      return (function (e) {
        return e
          ...
          .filter((e) => Fn(e.style.getPropertyValue("src")));
      })(n);
    }
        ...
        t.skipAutoScale ||
          (function (e) {
            (e.width > wn || e.height > wn) &&
              (e.width > wn && e.height > wn
                ? e.width > e.height
                  ? ((e.height *= wn / e.width), (e.width = wn))
                  : ((e.width *= wn / e.height), (e.height = wn))
                : e.width > wn
                ? ((e.height *= wn / e.width), (e.width = wn))
                : ((e.width *= wn / e.height), (e.height = wn)));
          })(r),
    ...
    const oo = [],
      ...
      ro = console.error,
      so = ["Audio callback had starved sending audio by"];
    let co = !1;
    const lo = Math.random().toString(36).substring(2);
    let po;
    function Ao() {
      const e = window;
    ...
    function mo(e, t = !0) {
      F.gameID && !F.isPlayground
        ? ao((t) => {
            try {
              const i = e.message || to(e);
              oo.push({ n: e.name, m: i, s: JSON.stringify(e.stack) }),
                po && po({ name: e.name, message: i, stack: e.stack });
              ...
              ro("%cPOKI:%c failed to log error", "font-weight: bold", "", e);
            }
          })
        : t &&
    ...
    function uo(e) {
      eo(e.reason)
        ...
        : mo({
            ...
            message: JSON.stringify(e.reason) || to(e),
          });
    }
    function go(e) {
      eo(e.error) ? mo(e.error) : mo(e);
    }
    function ho() {
      if (
        F.gameID &&
        ...
        (co = !0),
          window.addEventListener("unhandledrejection", uo),
          window.addEventListener("error", go);
        try {
          console.error = (...e) => {
            const t = to(e);
            so.some((e) => t.includes(e)) ||
              mo({ name: "console.error", message: t }, !1),
              ro.apply(console, e);
          };
        } catch {}
      }
    ...
    function wo() {
      if (co) {
        (co = !1),
          window.removeEventListener("unhandledrejection", uo),
          window.removeEventListener("error", go);
        try {
          console.error = ro;
        } catch {}
      }
          ...
          e &&
            (t = await (async (e, t) => {
              ...
              const l = new FontFace(
                ...
                [p, A, m, u] = await Promise.all([a, s, c, l]),
                g = document.createElement("canvas");
              (g.width = p.width), (g.height = p.height);
              const h = g.getContext("2d");
              h.drawImage(p, 0, 0);
              const w = g.width / A.width,
                v = A.height * w,
                f = g.height - v;
              h.drawImage(A, 0, f, g.width, v);
              const b = m.height * w;
              ((e, t, i, n, o, a, r) => {
                e.save(), e.beginPath();
                const s = i + o,
                ...
                e.moveTo(i + r, n),
                  ...
                  e.closePath(),
                  e.clip(),
                  e.drawImage(t, i, n, o, a),
                  e.restore();
              })(h, m, 64 * w, f + 20 * w, b, b, 24 * w);
              ...
              return (
                ...
                (h.textBaseline = "top"),
                (h.fillStyle = "#002b50"),
                (h.font = `700 ${56 * w}px TorusBold,sans-serif`),
                h.fillText(i, k, x),
                g.toDataURL()
              );
            })(t, e));
          return await vo({ screenshot: t });
        }
        return null;
      };
    const yo = M() || R() || he;
      ...
      update(e) {
        e &&
          ...
          (this.drawSize = Math.min(
            Math.max(this.drawSize, this.#z),
            this.#U
          ))),
          (this.drawSize -= this.#F),
          (this.drawSize = e
            ? Math.max(this.drawSize, this.#j)
    ...
    const Co = "Game tab in background";
    let Po = !0,
      Bo = [],
      To = null,
      ...
      Fo = 24;
    (M() || R() || he) && (Fo = 12),
      Do.setAttribute("data-poki-no-playtest", "true"),
      Do.addEventListener("webglcontextlost", () => {
        console.info(
    ...
    let Vo = !1,
      ...
      Xo = -1;
    function Yo(e) {
      if (null === To || !Bo.length) return;
      const t = Bo[0],
        i = t.width / To.width,
        n = t.height / To.height,
        o = (e.clientX - To.left) * i,
        a = (e.clientY - To.top) * n;
      (Go.x = Math.max(0, Math.min(o, t.width))),
        (Go.y = Math.max(0, Math.min(a, t.height)));
    }
    const Jo = (e) => {
        Bo.length && Do && Yo(e);
      },
      ea = (e) => {
        Bo.length &&
          ...
          (0 === e.button
            ...
            : 2 === e.button
            ? ((qo = !0), (Qo = !1))
            : 1 === e.button && ((Vo = !0), (Ho = !1), (qo = !0), (Qo = !1)),
          Yo(e));
      },
      ta = (e) => {
        0 === e.button
    ...
    function ia() {
      ...
      e &&
        Do &&
        Mo &&
        ((Mo.fillStyle = "rgba(255, 255, 255, 0.5)"),
        Mo.fillRect(0, 0, Do.width, Do.height),
        (Mo.font = "48px Arial"),
        (Mo.fillStyle = "#009cff"),
        (Mo.textAlign = "center"),
        Mo.fillText(e, Do.width / 2, Do.height / 2));
    }
    function na(e) {
      if (!Do || !Bo.length) return;
      const t = Bo[0],
        i = t.width,
        n = t.height;
      if (i === Zo && n === Xo && !e) return;
      (Zo = i), (Xo = n), (To = t.getBoundingClientRect());
      let { width: o, height: a } = To;
      (0 !== o && 0 !== a) || ((o = i), (a = n));
      const r = M() || R(),
        s = he ? 1024 : r ? 640 : 1280,
        d = Math.min(s / o, s / a, 1);
      (o = Math.round(o * d)),
        (a = Math.round(a * d)),
        (Ko = o / i),
        ($o = a / n);
      e || Do.width !== o || Do.height !== a
        ? ((Do.width = o),
          (Do.height = a),
          console.info(
            `%cPOKI_PLAYTEST:%c capturing at ${o}x${a} (${i}x${n})`,
            "font-weight: bold",
            ""
          ))
        : console.info(
            `%cPOKI_PLAYTEST:%c resize but video unchanged ${o}x${a} (${i}x${n})`,
            "font-weight: bold",
            ""
          );
    }
        ...
        if (!document.body.contains(e[i])) {
          ...
          if ((t || (t = document.getElementsByTagName("flt-glass-pane")), t)) {
            ...
            for (let o = 0; o < t.length; o++)
              t[o].shadowRoot?.contains(e[i]) && (n = !0);
            if (n) continue;
          }
          return !1;
        }
    ...
    async function aa(e) {
      if (
        ...
        (Ro ||
          ...
          0 === Bo.length
            ? ((Ro.width = Do.width), (Ro.height = Do.height))
            : ((Ro.width = Bo[0].width), (Ro.height = Bo[0].height)),
          Ro.addEventListener("contextlost", () => {
            (Ro = null), (Lo = null);
          })),
        Lo || ((Lo = Ro.getContext("2d")), Lo))
      )
        try {
          performance.now();
          ...
          if (t && t.length > 10) {
            ...
            requestAnimationFrame(() => {
              Ro &&
                Lo &&
                (Lo.clearRect(0, 0, Ro.width, Ro.height),
                Lo.drawImage(
                  e,
                  0,
                  0,
    ...
    async function sa(e) {
      if (!Po) {
        Bo = e;
        for (let e = 0; e < No.length; e++) No[e].stop();
        for (let e = 0; e < zo.length; e++) zo[e].readable.cancel();
        for (let e = 0; e < Uo.length; e++) Uo[e].cancel();
        for (let e = 0; e < jo.length; e++) jo[e].close();
        (No = []), (zo = []), (Uo = []), (jo = []);
        try {
          if (we)
            for (let e = 0; e < Bo.length; e++) {
              if (Bo[e].pokiHtmlDummyCanvas) continue;
              const t = Bo[e].captureStream(Fo).getVideoTracks()[0];
              No.push(t), jo.push(null);
              const i = new Blob(
                  [
            ...
            for (let e = 0; e < Bo.length; e++) {
              ...
              No.push(t), zo.push(i), Uo.push(n), jo.push(null);
              const o = () => {
            ...
            (function (e) {
              ...
              for (; t && t !== document.body; ) {
                ...
                if (i && (0 === t.offsetWidth || 0 === t.offsetHeight))
                  return !1;
                "absolute" === e.position && (i = !1), (t = t.parentElement);
              }
              const n = e.getBoundingClientRect(),
                o = window.innerHeight || document.documentElement.clientHeight,
                a = window.innerWidth || document.documentElement.clientWidth;
              return !(n.right < 0 || n.bottom < 0 || n.left > a || n.top > o);
            })(e) &&
            (r > i && (o = []),
    ...
    function ca(e, t) {
      if (!Do) return null;
      (Po = !1), sa(e), na(!0);
      const i = Do.captureStream(Fo);
      let n;
      window.addEventListener("pointermove", Jo, { capture: !0, passive: !0 }),
        window.addEventListener("pointerdown", ea, {
          capture: !0,
          passive: !0,
        }),
        window.addEventListener("pointerup", ta, { capture: !0, passive: !0 }),
        window.addEventListener("contextmenu", ta, {
          capture: !0,
          passive: !0,
        });
      let o,
      ...
      if (s === Ji || s === Yi) {
        ...
        n = setInterval(() => {
          if (!Do) return;
          const t = !!Bo[0].pokiHtmlDummyCanvas;
          !t ||
            (Bo[0].width === window.innerWidth &&
              Bo[0].height === window.innerHeight) ||
            ((Bo[0].width = window.innerWidth),
            (Bo[0].height = window.innerHeight));
          let i = !1;
          if (
            ...
            const t = (function (e) {
              ...
              for (; s < i; )
                (r =
                  ...
                  (r = (r << 15) | (r >>> 17)),
                  (r =
                    ((65535 & r) * o + ((((r >>> 16) * o) & 65535) << 16)) &
                    4294967295),
                  (a ^= r),
                  (a = (a << 13) | (a >>> 19)),
                  (a = (5 * a + 3864292196) & 4294967295);
              switch (((r = 0), t)) {
                case 3:
        ...
        (o = setInterval(() => {
          if (Po || !Do || !Bo.length || a > 10)
            return (
              ...
              window.removeEventListener("pointermove", Jo),
              window.removeEventListener("pointerdown", ea),
              window.removeEventListener("pointerup", ta),
              window.removeEventListener("contextmenu", ta),
              clearInterval(n),
              sn(""),
              (Do = null),
              (Mo = null),
          ...
          e === Xi
            ? (sn(""), aa(!1))
            : e === en && (sn(""), (Ro = null), (Lo = null)),
            Mo.clearRect(0, 0, Do.width, Do.height);
    ...
    function la() {
      ...
      e?.removeEventListener("pointerdown", la),
        t?.removeEventListener("pointerdown", la),
    ...
    function Aa({ gameTitle: e, rejectCallback: t, resolveCallback: i }) {
      ...
      const o = document
        ...
        .content.cloneNode(!0);
      (o.querySelector("#poki-playtest-popup-game-title").textContent = e),
        (async function () {
          const e = new FontFace(
            ...
            [n, o, a] = await Promise.all([e, t, i]);
          document.fonts.add(n), document.fonts.add(o), document.fonts.add(a);
        })().then(() => {
          n.appendChild(o),
            (function ({ rejectCallback: e, resolveCallback: t }) {
              ...
              const o = document.getElementById("poki-playtest-popup-wrapper");
              o &&
                [
                  "pointerdown",
                  "pointerup",
                  ...
                  "contextmenu",
                  "dragstart",
                ].forEach((e) => o.addEventListener(e, pa));
            })({ rejectCallback: t, resolveCallback: i });
        });
    }
    const ma = window.requestAnimationFrame;
    function ua(e) {
    ...
    class ga {
      ...
      stats() {
        if (0 === this.#G.length) return;
        const e = Math.min(...this.#G),
          t = Math.max(...this.#G),
          i = ua(this.#G.reduce((e, t) => e + t, 0) / this.#G.length);
        let n = ua(
          this.#G
            .slice(1)
            .map((e, t) => Math.abs(e - this.#G[t]))
            .reduce((e, t) => e + t, 0) /
            (this.#G.length - 1)
        );
    ...
    function ha(e) {
      ...
      for (let n = 0; n < e.length; n++) {
        ...
        const o = e[n];
        if ("string" == typeof o)
          (i = (o.match(/%c/g) || []).length), t.push(o.replace(/%c/g, ""));
        else
          try {
            t.push(String(o));
          } catch (e) {
    ...
    const ka = window.requestAnimationFrame;
    function xa(e) {
      ...
      window.addEventListener("beforeunload", () => {
        ...
        (s = []),
          ...
          xa({
            ...
            total_duration: c,
            timed_out: !0,
            sdk_version: "9d30ff633644aaf120bae76a1f5bdd378eb18eaa",
            fpss: d,
            upvotes: o,
            downvotes: a,
            have_interaction: ya() > 0,
          });
      });
      window.addEventListener("message", (e) => {
        e.data &&
          "vote" === e.data.type &&
          (e.data.direction < 0 ? a++ : e.data.direction > 0 && o++);
      });
      return (
        setInterval(() => {
          const r = fa() > 0,
    ...
    try {
      const e = (e) => {
        ...
        (console[e] = (...i) => {
          t.apply(console, i),
            Ra &&
              Ra.push({ timeMs: performance.now(), level: e, message: ha(i) });
        }),
          Ma.push(() => {
            console[e] = t;
          });
    ...
    function La() {
      (Ca = null), Ma.forEach((e) => e()), (Ma = []), (Ra = null);
    }
    function Oa(t, i, n) {
      console.info(
      ...
      const o = ca(t, () => {
        Pa?.close(1e3, "Playtest recording stopped");
      });
      o &&
        ((Pa = new WebSocket("wss://playtest-recorder.poki.io/ws")),
        Pa.addEventListener("error", () => {
          te.track(e.tracking.playtest.error, { message: "websocket error" }),
            console.info("%cPOKI_PLAYTEST:%c error", "font-weight: bold", "");
        }),
        Pa.addEventListener("open", () => {
          if (!Pa) return;
          if (Pa.readyState === Pa.OPEN) {
            let e;
            try {
              const t = document.createElement("canvas"),
                i = {
          ...
          (Ea = (e, t) => {
            if (!Pa || Pa.readyState !== Pa.OPEN) return;
            Pa.send(to({ type: "sdk-event", offset: s(t), event: e }));
            const i = Da[e];
            i &&
              Pa.send(
                to({
          ...
          const m = new ga(1),
            u = setInterval(() => {
              Pa &&
                Pa.readyState === Pa.OPEN &&
                Pa.send(
                  JSON.stringify({ type: "fps", offset: s(), stats: m.stats() })
                );
            }, 1e3);
          Pa.addEventListener("close", (t) => {
            console.info(
    ...
    !(function (e) {
      ...
      if (
        ...
        try {
          Ea(t.event),
            null !== Ca &&
              Ca.push({ event: t.event, timeMs: performance.now() });
        } catch (e) {
    ...
    function Na(t) {
      const i = (function (e) {
          ...
          if (e.playtestVersion && e.playtestVersion !== F.versionID) return !1;
          if (e.playtestNewUser && Sa) return !1;
          const t = M() || R() || he;
        ...
        n = (function () {
          ...
          return (
            (ge() || he || we) && (e = 'video/mp4;codecs="avc1.42000d"'),
      ...
      if (i && n && !o) {
        ...
        te.track(e.tracking.playtest.showModal, { show: !0 }),
          ...
          new Promise((e, t) => {
            console.info(
              ...
              Aa({ rejectCallback: t, resolveCallback: e, gameTitle: a });
          }))
            .then(() => {
        ...
        if (o || (t.metrictestID && F.isPokiIframe)) {
          const i = _a(t);
    ...
    function Ga() {
      window.navigator.userAgent.match(Fa) &&
        !F.isPlayground &&
    ...
    class Ha {
      #Q = null;
      #W() {
        if (!F.isPokiIframe) throw new Error("User accounts is not available");
      }
      getUser = async () =>
        V.debug
          ? {
          ...
          : (this.#W(), this.#Q || (this.#Q = await this.#K()), this.#Q);
      getToken = async () =>
        V.debug
          ...
          : new Promise((t, i) => {
              function n(t) {
                t.data.type === e.accounts.authPanelClosed &&
                  ...
                  i(
                    new Error("User closed the auth panel without signing in.")
                  ));
              }
              window?.top?.postMessage({ type: e.accounts.openAuthPanel }, "*"),
          ...
          return new Promise((t) => {
            ...
            const i = (n) => {
              if (n.data.type === e.accounts.userInfo) {
                ...
                const { enabled: e, session: o } = n.data;
                if (!e || !o?.id) return void t(null);
                (this.#Q = {
                  username: Va(),
                  avatarUrl:
      ...
      #$ = async () => {
        try {
          return new Promise((t) => {
            ...
            const i = (n) => {
              if (n.data.type === e.accounts.userToken) {
                window.removeEventListener("message", i);
                const { token: e, error: o } = n.data;
                if (o) return $("failed to fetch user token:", o), void t(null);
          ...
          $("failed to fetch user token:", e);
        }
        return null;
      };
    }
    const qa = atob("c3VibWl0U2NvcmU=");
    const Qa = class {
        __monetization;
        __gameStarted = !1;
        #Z = !1;
        ...
        init = (t = {}) => {
          if ((this.__logCall("init", t), this.#re))
            return Z("PokiSDK.init() called more than once"), this.#re;
          t[qa] &&
            t[qa]((t, i) => {
              !(function (t, i) {
            ...
            (this.#re = new Promise((i) => {
              this.__monetization.init({
                ...
                G.sendMessage(e.message.sdkDetails, {
                  version: "9d30ff633644aaf120bae76a1f5bdd378eb18eaa",
                });
            })),
            this.#re
          );
              ...
              if ("pokiGenerateScreenshot" === t.data.type)
                (async (t) => {
                  ...
                  if (i) {
                    ...
                    n = await bo({ title: e, thumbnail: i });
                  } else n = await bo();
                  const o = { screenshot: n, errors: oo };
                  t.callback && (o.callback = t.callback),
                    G.sendMessage(e.message.sendGameScreenshot, { data: o });
                })(t.data);
              ...
              async (t) => {
                if (
                  ...
                  try {
                    ...
                    $("PokiSDK: Error clearing localStorage", t),
                      G.sendMessage(e.message.sendInspectorEvent, {
        ...
        setDebug = (t = !0) => {
          ...
          const { hostname: i } = window.location;
          i.endsWith("poki-gdn.com")
            ? t && te.track(e.tracking.debugTrueInProduction)
            : ((V.debug = t), (V.log = t ?? V.log), t ? wo() : ho());
        };
        setLogging = (e) => {
          this.__logCall("setLogging", e), (V.log = e);
        };
        #le = () => this.#te >= 10;
        gameLoadingFinished = () => {
        ...
        gameplayStart = (t) => {
          if ((this.__logCall("gameplayStart", t), this.#le()))
            return void $(
          ...
          (this.#Z = !0),
            this.__gameStarted ||
              ...
              window.pokiMeasureBuildin &&
                window.PokiSDK.measure("game", "play", "first"));
          const i = this.#te;
          setTimeout(() => {
            let n;
            performance.now() - ya() < 5e3 && (n = this.#J),
            ...
            this.#ee &&
              (this.#ee > performance.now() - 50 && this.#te++, (this.#ee = 0));
        };
        gameplayStop = (t) => {
            ...
            this.__runVideoAd({
              ...
              onStart: () => {
                if (
                  ...
                  (o = !0),
                  window.pokiMeasureBuildin &&
                    window.PokiSDK.measure("midroll", this.#ie, "start"),
                  "function" == typeof t)
                )
                  try {
                    t();
              ...
              o &&
                window.pokiMeasureBuildin &&
                window.PokiSDK.measure("midroll", this.#ie, "complete"),
                i();
            });
          });
        rewardedBreak = (t) =>
              ...
              this.__runVideoAd({
                ...
                onStart: () => {
                  if (
                    ...
                    (a = !0),
                    window.pokiMeasureBuildin &&
                      window.PokiSDK.measure("rewarded", this.#ne, "start"),
                    "function" == typeof n)
                  )
                    try {
                      n();
                ...
                a &&
                  window.pokiMeasureBuildin &&
                  window.PokiSDK.measure("rewarded", this.#ne, "complete"),
                  i(e);
              });
            }, 0);
          });
        displayAd = (t, i, n, o) => {
          if (
            (this.__logCall("displayAd", t, i, n, o),
            "977b60eb-ff81-4c3a-895b-b585410d6c0d" === F.gameID)
          )
            return void (n && n());
          const a = Bt();
        ...
        playtestSetCanvas = (e) => {
          if ((this.__logCall("playtestSetCanvas", e), !e)) return void an([]);
          const t = [].concat(e);
          an(t), sa(t);
        };
        playtestCaptureHtmlOnce = () => {
          this.__logCall("playtestCaptureHtmlOnce"), sn(Xi);
        };
        playtestCaptureHtmlForce = () => {
          this.__logCall("playtestCaptureHtmlForce"), sn(Yi);
        };
        playtestCaptureHtmlOn = () => {
          this.__logCall("playtestCaptureHtmlOn"), sn(Ji);
        };
        playtestCaptureHtmlOff = () => {
          this.__logCall("playtestCaptureHtmlOff"), sn(en);
        };
        ...
        shareableURL = (t = {}) =>
          new Promise((i, n) => {
            ...
            if (F.isPokiIframe || F.isInspector) {
              const n = D("poki_url");
              a.forEach((e) => {
                void 0 !== t[e] && null !== t[e] && o.set(`gd${e}`, t[e]);
              }),
                i(`${n}?${o.toString()}`),
              ...
              window.self === window.top
                ? (a.forEach((e) => {
                    void 0 !== t[e] && null !== t[e] && o.set(`${e}`, t[e]);
                  }),
                  i(
        ...
        __runVideoAd = ({
          ...
          new Promise((a) => {
            let r = 1;
            this.__monetization.setNrAds(r, i);
            const s = Bt(),
              d = (n) => {
                setTimeout(() => {
                  ...
                  if (r === i || this.#ae)
                    return (
                      Q.dispatchEvent(e.ads.startTimer, {
                        overwriteTimeBetweenAds: o,
                      }),
                      void a(!!n?.rewardAllowed)
                    );
                  const c = Q.getVideoDataAnnotations();
                  if ("poki" === c?.bidder)
                    return (
                      Q.dispatchEvent(e.ads.startTimer, {
                        overwriteTimeBetweenAds: o,
                  ...
                  r++,
                    ...
                    this.__monetization.setNrAds(r, i),
                    this.__monetization.requestAd({ position: t, onFinish: d });
                }, 0);
              };
            Q.clearVideoDataAnnotations(),
              Q.addVideoDataAnnotations({
              ...
              this.__monetization.requestAd({
                ...
                onStart: () => {
                  if (
                    (this.__monetization.setNrAds(r, i), "function" == typeof n)
                  )
                    try {
                      n();
                    } catch (e) {
      ...
      Wa = new Qa(
        new (class {
          ...
          #ye = !1;
          #ke = {};
          #xe = { blocklist: [], countryExclusion: [], bidderLimitation: {} };
          #_e;
          #Ie = { isRequesting: !1, position: null };
          #Se;
          #Ee = !1;
          #Ce = !1;
          #Pe = !1;
          ...
          constructor() {
            (window.googletag = window.googletag || { cmd: [] }),
              ...
              (this.display = Kt() ? new Zi() : new $i());
          }
          init(e = {}) {
            if ("undefined" == typeof window) return;
            const { onReady: t = null } = e;
            if (((this.#ke = e), t && this.#Re("onReady", t), !this.#ve))
              return (
                this.#he ||
                  ((e.strictConsentMode || F.gdprApplies) && (this.#Be = !0),
                  (this.#he = this.#Le())),
                this.#he
              );
            console.error(
          ...
          #Le() {
            ...
            V.init(t, i),
              ...
              F.isPokiIframe && setTimeout(oe.trackSavegames, 1e4),
              (this.#we = new Hi({ wrapper: n })),
              window.addEventListener(
                "resize",
            ...
            const a =
              void 0 !== this.#ke.isCCPA ? this.#ke.isCCPA : F.ccpaApplies;
            let r = Wi;
            const s = (this.#ke.country || F.country).toUpperCase();
            s &&
              void 0 !== a &&
              (r = () => Promise.resolve({ ISO: s, ccpaApplies: a }));
            const d = [...[o(), r()], Ki()];
            return Promise.allSettled(d)
              .then((t) => {
                try {
                  ...
                  let d = { ISO: "ZZ", ccpaApplies: !1 };
                  if (
                    ("fulfilled" === o.status && (d = o.value),
                    j("country", (s || d?.ISO || "ZZ").toUpperCase()),
                    j("gdprApplies", T(F.country)),
                    j("ccpaApplies", void 0 === a ? d?.ccpaApplies || !1 : a),
                    F.gdprApplies && (this.#Be = !0),
                    Ae(),
                    "fulfilled" === r.status)
                  ) {
                    const e = r.value;
                  ...
                  (i = this.#xe.blocklist),
                    (Ce = i || []),
                    this.#Be && Q.dispatchEvent(e.ready),
                    F.isPlayground ||
                      F.isPokiExternal ||
          ...
          async loadMonetizationCore() {
            ...
            if (F.isInspector)
              return void (this.#Be || Q.dispatchEvent(e.ready));
            ...
            return (
              ...
              d.push(X("./poki-sdk.js")),
              a ? d.push(Promise.resolve()) : d.push(X("./poki-sdk.js")),
              F.familyFriendly || F.nonPersonalized
                ? (d.push(
                  ...
                  F.familyFriendly && $i.enforceFamilyFriendlyFlow(),
                  j("nonPersonalized", !0),
                  $i.enforceNonPersonalized())
                : d.push(yt(), X("./poki-sdk.js"), X("./poki-sdk.js")),
              this.display.setupSlotRenderEndedListener(),
              Promise.allSettled(d)
                .then((r) => {
                  try {
                    const [s, d, c, l, p] = r;
                    "rejected" === s.status && (this.#De = !0),
                      "rejected" === c.status &&
                      ...
                      Ht(t, this.#xe.bidderLimitation),
                      Vt(i, this.#xe.bidderLimitation),
                      (() => {
                        ti.log("Loading rewarded web"),
                          Yt?.contentWindow ||
                            (ni(),
                            ti.log("No iframe content window available"));
                        let t = 0;
                          ...
                          if (i.data?.type)
                            switch (i.data.type) {
                              ...
                              case "rewardedSlotGranted":
                                ti.log("Received reward granted from iframe"),
                                  (Zt = !0);
                                break;
                              case "rewardedSlotClosed":
                                ti.log("Received slot closed from iframe", {
                                  grantReward: Zt,
                                }),
                                  ai(!1),
                                  Zt
                                    ? te.track(
                                        e.tracking.ads.rewardedWeb.closedGranted
                                      )
                                    : te.track(
                              ...
                              case "rewardedSlotRequested":
                                ti.log("Received slot requested from iframe", {
                                  hasEvent: i.data,
                                }),
                                  i.data.hasEvent ||
                                    (te.track(e.tracking.ads.rewardedWeb.empty),
                      ...
                      (() => {
                        let t;
                        li.log("Loading interstitial web"),
                          si?.contentWindow ||
                            (mi(),
                            li.log("No iframe content window available")),
                          window.addEventListener("message", (i) => {
                            if (i.data?.type)
                              switch (i.data.type) {
                                ...
                                case "gameManualInterstitialSlotClosed":
                                  li.log("Received slot closed from iframe"),
                                    Ai(!1),
                                    Q.dispatchEvent(e.ads.completed, {
                                      rewardAllowed: !0,
                                    });
                    ...
                    if (
                      ...
                      (this.#o = { ...A.customCriteria, ay_mode: F.AYMode }),
                      (this.#i = new qi(n)),
                      this.#we.setupEvents(this),
                      this.#ye && za.startStartAdsAfterTimer(),
                      (this.#fe = new bi(this.#i, {
                        timing: za,
                        totalRetries: o,
                      })),
                      (this.#Te = !0),
          ...
          requestAd(t = {}) {
            const {
              ...
              r = Q.getVideoDataAnnotations();
            if (
              (te.track(
                a === e.ads.position.rewarded
                  ? e.tracking.screen.rewardedBreak
                  : e.tracking.screen.commercialBreak,
                r
              ),
              this.#Ie.isRequesting)
            ) {
              if (n)
                try {
                  n({ type: e.ads.busy, rewardAllowed: !1 });
                } catch (e) {
                  $("error in onFinish callback", e);
                }
              return;
            }
            if (
              ((this.#Ie = { isRequesting: !0, position: a }),
              (this.#Ae = !1 !== i),
              this.#Re("onFinish", (e) => {
                if ((o && this.#Ne("onStart"), n)) {
                  this.#Ne("onFinish");
                  try {
                    n(e);
                  } catch (e) {
              ...
              this.#Re("onStart", (t) => {
                Q.dispatchEvent(e.playtest.startVideo, { position: a }),
                  o && o(t);
              }),
              null === a || !P(a, e.ads.position))
            )
              return (
                Z(`invalid position: ${a}`),
                void Q.dispatchEvent(e.ads.error, r)
              );
            if (this.#Pe)
              return (
                $("Display only mode, no video ads available"),
                void Q.dispatchEvent(e.ads.error, r)
              );
            if (!this.#ve)
              return (
                Z("Requesting ad before PokiSDK.init() is done"),
                Q.dispatchEvent(e.ads.error, r),
                void this.#ze()
              );
            if (this.#i?.isAdRunning?.() || this.#fe?.isRunning?.())
              return (
                Z("a video ad is already running"),
                void Q.dispatchEvent(e.ads.busy, r)
              );
            if (!F.adOverrideMode) {
              if (a === e.ads.position.preroll && !za.prerollPossible())
                return (
                  K("commercialBreak not possible before gameplayStart"),
                  void Q.dispatchEvent(e.ads.limit, {
                    ...r,
                    reason: e.info.messages.prerollLimit,
                  })
                );
              if (a !== e.ads.position.rewarded && !za.requestPossible())
                return (
                  K("commercialBreak too soon after previous one"),
                  void Q.dispatchEvent(e.ads.limit, {
                    ...r,
              ...
              if (
                a !== e.ads.position.rewarded &&
                this.#xe.countryExclusion.includes(F.country)
              )
                return (
                  K(
            ...
            if (F.kioskMode)
              return a === e.ads.position.rewarded
                ? void this.#Ue()
                : void Q.dispatchEvent(e.ads.limit, {
                    ...r,
                    reason: e.info.messages.disabled,
                  });
            if (this.#Be && !this.#Te && !F.adOverrideMode && !F.googlePreview)
              return a === e.ads.position.rewarded || V.debug
                ? void this.#Ue()
                : (K("commercialBreak not possible before consent"),
                  void Q.dispatchEvent(e.ads.error, r));
            if (!this.#i || this.#Ce || this.#Me)
              return void (a === e.ads.position.rewarded || F.isInspector
                ? this.#Ue()
                : Q.dispatchEvent(e.ads.error, r));
            if (me())
              return (
            ...
            if (ue())
              return (
                Z("No USP detected!"), void Q.dispatchEvent(e.ads.error, r)
              );
            if (this.#Ee) return void Q.dispatchEvent(e.ads.ready, r);
            const s = {
              ...this.#je(),
              ...this.#o,
              position: a,
              ab: Math.floor(100 * Math.random()).toString(),
              refresh_number: this.#me[a],
              total_refresh_number: this.#ue[a],
            };
            this.#me[a]++,
              this.#ue[a]++,
              this.#we.show(),
              ...
              !F.kioskMode &&
                (V.debug
                  ...
                  ? this.#ve
                    ...
                    : (Z("Requesting ad on unbooted SDK"), this.#ze(), !1)
                  : (Z(
          ...
          startStartAdsAfterTimer() {
            this.#ze() ? (this.#ye = !0) : za.startStartAdsAfterTimer();
          }
          muteAd() {
            this.#ze() || this.#i.muteAd();
          }
          isAdBlocked = () => !1;
          setVolume(e) {
            this.#ze() || this.#i?.setVolume(e);
          }
          forcePreroll() {
            if (this.#ze()) return;
            const t = za.prerollPossible;
            (za.prerollPossible = () => !0),
              this.requestAd({ position: e.ads.position.preroll }),
              (za.prerollPossible = t);
          }
          resumeAd() {
            this.#ze() || (this.#we.hidePauseButton(), this.#i.resumeAd());
          }
          startAdClicked() {
            this.#ze() ||
              (ge() &&
          ...
          stopVideoAd() {
            this.#we.hide(),
              ...
              this.#ze() ||
                (this.#Ie.isRequesting &&
                  (this.#fe.stopWaterfall(),
                  this.#i.stopPlayback(),
                  this.#Ie.position === e.ads.position.rewarded
                    ? (ti.log("Destroying rewarded web", new Error().stack),
                      Yt &&
                        (Yt.remove(),
                        (Yt = null),
                        ti.log("Iframe removed"),
                        (Xt = !1),
                        (Zt = !1)))
                    : (li.log("Destroying interstitial web", new Error().stack),
                      si &&
                        (si.remove(),
                        (si = null),
                        li.log("Iframe removed"),
                        (ri = !1))),
                  (this.#Ie = { isRequesting: !1, position: null })));
          }
          resizeVideoAd() {
            if (!this.#i) return;
          ...
          #Oe() {
            Q.addEventListener(e.ready, () => {
              (this.#ve = !0), this.setVolume(0.6), this.#Ge("onReady");
            }),
              Q.addEventListener(e.failed, () => {
                (this.#ve = !0), (this.#Ce = !0);
              }),
              Q.addEventListener(e.ads.ready, () => {
                (this.#Ee = !0), this.#Ae && this.#Fe();
              }),
              Q.addEventListener(e.ads.started, () => {
                this.#we.hideSpinner(),
                  this.#Ge("onStart", { type: e.ads.limit });
              }),
              ...
              Q.addEventListener(e.ads.busy, () => {
                (this.#Ie = { isRequesting: !1, position: null }),
                  this.#Ge("onFinish", { type: e.ads.busy, rewardAllowed: !1 });
              }),
              ...
              [
                ...
                Q.addEventListener(e, () => {
                  this.#we && this.#we.hide(), (this.#Ee = !1);
                });
              });
          }
          #ze = () =>
          ...
          #je = () => {
            ...
            return (
              F.specialCondition &&
              this.#_e &&
              this.#_e.includes(F.specialCondition)
          ...
          #Ue = () => {
            ...
            (async function () {
              const e = await ke(
                  "https://api.poki.com/ads/houseads/video/vast"
                ),
                t = await e.text(),
                i = new DOMParser().parseFromString(t, "text/xml"),
                n = i.querySelector("ClickThrough")?.textContent?.trim() || "",
                o = (
                  i.querySelector("Duration")?.textContent?.trim() || "00:00:11"
                ).split(":"),
                a = 60 * +o[0] * 60 + 60 * +o[1] + +o[2];
              let r = "";
              return (
                ...
                F.kioskMode
                  ? { duration: a, videoUrl: r }
                  : { clickThrough: n, duration: a, videoUrl: r }
              );
            })()
              .then((e) => {
                try {
    ...
    for (const e in Wa) e.startsWith("__") || (window.PokiSDK[e] = Wa[e]);
  })();
})();
