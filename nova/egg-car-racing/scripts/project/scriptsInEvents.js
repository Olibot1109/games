...
const scriptsInEvents = {
	...
	async Menu_sheet_Event5_Act1(runtime, localVars)
	{
		InitExternEval();
	},

	async Menu_sheet_Event6_Act1(runtime, localVars)
	{
		ExternEval();
	},

	async Garage_sheet_Event9_Act4(runtime, localVars)
	{
		ShowRewarded();
	},

	async Garage_sheet_Event10_Act1(runtime, localVars)
	{
		TakeReward();
	},
	...
	async Ads_Event1_Act4(runtime, localVars)
	{
